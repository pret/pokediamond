...
struct PoffinCaseAppData *sub_0208890C(u32 a0, struct SaveData *save, enum HeapID heapID, u32 *a3) {
    struct PoffinCaseAppData *ret = Heap_Alloc(heapID, sizeof(struct PoffinCaseAppData));
...
struct PoffinCaseAppData *sub_02088960(struct FieldSystem *fieldSystem, u32 a1, enum HeapID heapID) {
