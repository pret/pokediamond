...
THUMB_FUNC void FUN_02088950(struct FieldSystem *fieldSystem, struct UnkStruct_0208890C* unk2)
{
    FUN_020373D4(fieldSystem, (struct Unk21DBE18*)&UNK_020FD6E4, unk2);
}
