...
const struct UnkStruct_02031734_const2 UNK_020EEC48 = { { (u32)sub_02032B84, 0 } };
...
void sub_02033288(struct SaveData *save)
{
    if (UNK_021C5A00 == NULL)
    {
        ...
        UNK_021C5A00 =
            (struct UnkStruct_02031734 *)AllocFromHeap(HEAP_ID_15, sizeof(struct UnkStruct_02031734));
