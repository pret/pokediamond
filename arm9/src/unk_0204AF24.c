...
{
    if(!sub_0203739C(sub_02046528(taskManager)))
    {
        return TRUE;
    }
    return FALSE;
...
void sub_0204AF3C(struct TaskManager *taskManager)
{
    ...
    sub_0204640C(taskManager, &sub_0204AF24, NULL);
}

BOOL sub_0204AF6C(struct TaskManager *taskManager)
{
    if(sub_020464A4(sub_02046528(taskManager)))
    {
        return TRUE;
    }
    return FALSE;
...
void sub_0204AF84(struct TaskManager *taskManager) //TODO: RestoreOverworld
{
    ...
    sub_0204640C(taskManager, &sub_0204AF6C, NULL);
}
...
void sub_0204AFC8(struct TaskManager *taskManager)
{
    ...
    sub_0204640C(taskManager, &sub_0204AFB4, 0);
}
...
{
    sub_0204640C(taskManager, &sub_0204B050, 0);
}
...
{
    sub_0204640C(taskManager, &sub_0204B0A0, 0);
}
