...
THUMB_FUNC u32 FUN_0202F150(u32 param0, u32 param1)
{
    ...
    if (param0 != 0)
    {
        ...
        if (FUN_02033534() == 0xa)
        {
            FUN_0202D7D8(UNK_021C59F8->unk54C, 0x64, &UNK_021C59F8->unk464);
            FUN_0202D7D8(UNK_021C59F8->unk56C, 0x32 << 4, &UNK_021C59F8->unk4DC);
        }
        else
        {
            FUN_0202D7D8(UNK_021C59F8->unk54C, 0x14, &UNK_021C59F8->unk464);
            FUN_0202D7D8(UNK_021C59F8->unk56C, 0x1b + 0xfd, &UNK_021C59F8->unk4DC);
        }
    }
    else
    {
    ...
    FUN_020312BC(UNK_021C59F8->unk5F8);
...
THUMB_FUNC void FUN_0202F2F0()
{
    ...
    for (i = 0; i < res; i++)
    {
        FUN_0202D394(&UNK_021C59F8->unk4E8[i],
    ...
    for (i = 0; i < res; i++)
    {
        FUN_0202D394(&UNK_021C59F8->unk47C[i],
            UNK_021C59F8->unk454 + i * UNK_021C59F8->unk658,
            UNK_021C59F8->unk658);
    }

    MI_CpuFill8(&UNK_021C59F8->unk2D4, 0, 6 << 6);
    FUN_0202D394(&UNK_021C59F8->unk4DC, UNK_021C59F8->unk2D4, 6 << 6);
    ...
    FUN_0202D394(&UNK_021C59F8->unk464, UNK_021C59F8->unk04c, 0x42 << 2);
    ...
    FUN_0202D804(UNK_021C59F8->unk54C);
    FUN_0202D804(UNK_021C59F8->unk56C);
...
THUMB_FUNC void FUN_0202F820(int param0)
{
    ...
    FUN_0202D394(&UNK_021C59F8->unk47C[param0],
        UNK_021C59F8->unk454 + param0 * UNK_021C59F8->unk658,
        UNK_021C59F8->unk658);

    FUN_0202D394(&UNK_021C59F8->unk4E8[param0],
...
THUMB_FUNC void FUN_0202F8D4()
{
    for (int i = 1; i < 8; i++)
    {
        if (FUN_02030E7C((u16)i) == 0 && UNK_021C59F8->unk667[i] == 0 && FUN_02031280() == 0)
        {
            FUN_0202F820(i);
        }
    }
...
THUMB_FUNC void FUN_0202FA5C()
{
    ...
    if (r4 != 0)
    {
        ...
        FUN_0200CAB4(UNK_021C59F8->unk548);
        ...
        FUN_0202D824(UNK_021C59F8->unk56C);
        FUN_0202D824(UNK_021C59F8->unk54C);
...
THUMB_FUNC BOOL FUN_0202FB80()
{
    ...
    if (UNK_021C59F8 != NULL)
    {
        ...
        FUN_0202ED70(UNK_021C59F8->unk65C);
...
THUMB_FUNC void FUN_0202FCCC()
{
    ...
    if (FUN_02033534() >= 0x13)
    {
        ...
        if (UNK_021C59F8->unk630 != 0)
        {
            ...
            if (UNK_02105D58 == 4)
            {
                FUN_02030930(UNK_021C59F8->unk000[0]);
                UNK_02105D58 = 2;
            }
        }
        else
        {
            if (UNK_02105D58 == 4)
            {
                if (FUN_02030930(UNK_021C59F8->unk000[0]) == 0)
                {
                    return;
                }
    ...
    FUN_02030930(UNK_021C59F8->unk000[UNK_021C59F8->unk67F]);

    FUN_02030930(UNK_021C59F8->unk000[1 - UNK_021C59F8->unk67F]);
...
#ifdef NONMATCHING
THUMB_FUNC BOOL FUN_0202FE2C(int param0)
{
    ...
    stc = FUN_02031228(FUN_02033534());
    st8 = FUN_0202D858(FUN_02033534()) + 1;

    for (r7 = 0; r7 < st8; r7++)
    {

        FUN_0202D4BC(&UNK_021C59F8->unk47C[r7]);
...
#else
THUMB_FUNC asm BOOL FUN_0202FE2C(int param0)
{
    // clang-format off
	push {r3-r7, lr}
	sub sp, #0x10
...
{
    if (UNK_021C59F8 == NULL || FUN_02033534() >= 0x13)
    {
        return;
    }
    ...
    if (UNK_02105D59 == 2 || UNK_02105D59 == 0)
    {
        ...
        if (FUN_0202FA28() == 1)
        {
            FUN_0202FE2C(UNK_021C59F8->unk680);
        }

        if (FUN_0202CBD4() == 4 && FUN_02031280() == 0)
        {

            if (FUN_0202D0D0(UNK_021C59F8->unk154[UNK_021C59F8->unk680],
                    0xc0,
                    0xe,
                    FUN_020304F0) == 0)
            {
        ...
        if (UNK_02105D59 == 1 || UNK_02105D59 == 3)
        {
            ...
            FUN_0203026C(0, UNK_021C59F8->unk154[UNK_021C59F8->unk680], 0xc0);
...
THUMB_FUNC void FUN_02030074()
{
    if (UNK_021C59F8->unk683 != 0)
    {
        if (FUN_02033534() >= 0x13)
        {
            if (FUN_02030E7C(0) != 0 && MOD04_021D79B4(UNK_021C59F8->unk154, 0x4c) != 0)
            {
                UNK_021C59F8->unk683 = 0;
                return;
            }
    ...
    else if (FUN_0202CBD4() == 4 || FUN_02031280() != 0)
    {
        if (UNK_02105D59 == 4)
        {
            ...
            if (FUN_0202FA28() == 0)
            {
                FUN_02030A00(UNK_021C59F8->unk154[UNK_021C59F8->unk680]);
                FUN_02030A00(UNK_021C59F8->unk154[1 - UNK_021C59F8->unk680]);
            }
...
#pragma unused(param2)
    ...
    if (FUN_0202FA28() == 1)
    {
        ...
        while (r4 < st4)
        {
            ...
            {
                param1++;
                FUN_0202D3A4(&UNK_021C59F8->unk4E8[r4], param1, (u32)(r6 - 1), 0x5E6);
    ...
    FUN_0202D3A4(&UNK_021C59F8->unk470, param1 + 4, param1[3], 0x5FF);
}
...
#pragma unused(param2)
    ...
    if (FUN_0202FA28() == 1)
    {
        ...
        if ((param1[0] & 2) == 0)
        {
            FUN_0202D3A4(&UNK_021C59F8->unk47C[param0], param1, (u32)r6, 0x65E);
        }
    ...
    if ((param1[0] & 2) == 0 && FUN_0202D498(&UNK_021C59F8->unk4E8[param0]) >= 0xb)
    {
        FUN_0202D3A4(&UNK_021C59F8->unk4E8[param0], param1 + 1, 0xb, 0x66E);
    }
}
...
{
    if (UNK_021C59F8 == 0 || FUN_02033534() >= 0x13)
    {
        return;
    }
    ...
    if (FUN_02031280() != 0 && (UNK_02105D58 == 2 || UNK_02105D58 == 0))
    {
        ...
        FUN_020303F4(0, UNK_021C59F8->unk000[UNK_021C59F8->unk67F], (u16)r4);
    ...
    if (FUN_02031190() != 0)
    {
        ...
        if (FUN_0202D0D0(UNK_021C59F8->unk000[UNK_021C59F8->unk67F],
                (u16)r4,
                0xe,
                FUN_020304D4) == 0)
        {
...
THUMB_FUNC u32 FUN_02030930(u8 *param0)
{
    ...
    if (FUN_0202D4E4(UNK_021C59F8->unk54C) != 0)
    {
        param0[0] |= 2;
        if (param0[0] == 2)
        {
    ...
    else
    {
        ...
        st0[1] = r5 - 1;
        st0[0] = (int)param0 + 1;
        if (FUN_0202D760(UNK_021C59F8->unk54C, st0, 1) == 0)
        {
...
THUMB_FUNC void FUN_02030A00(u8 *param0)
{
    ...
    st0[1] = 0xbb;
    st0[0] = (int)param0 + 5;
    if (FUN_0202D760(UNK_021C59F8->unk56C, st0, 0) != 0)
    {
        UNK_021C59F8->unk685 = 0;
...
THUMB_FUNC u32 FUN_02030A78(u32 param0, u8 *param1, u32 param2)
{
    ...
    if (FUN_0202D684(UNK_021C59F8->unk54C, param0, param1, param2, 1, 0) != 0)
    {
        return 1;
    }
...
THUMB_FUNC u32 FUN_02030ADC(u32 param0, u8 *param1, u32 param2)
{
    ...
    if (FUN_0202D684(UNK_021C59F8->unk54C, param0, param1, param2, 1, 1) != 0)
    {
        return 1;
    }
...
THUMB_FUNC u32 FUN_02030B3C(u32 param0, u8 *param1, u32 param2)
{
    ...
    if (FUN_0202D684(UNK_021C59F8->unk56C, param0, param1, param2, 1, 0) != 0)
    {
        return 1;
    }
...
THUMB_FUNC u32 FUN_02030BC4(u32 param0, u8 *param1, u32 param2)
{
    ...
    if (FUN_0202D684(UNK_021C59F8->unk56C, param0, param1, param2, 1, 1) != 0)
    {
        return 1;
    }
...
{
    return FUN_0202D498(&UNK_021C59F8->unk464);
}
...
THUMB_FUNC void FUN_02030DA4()
{
    if (UNK_021C59F8 != NULL)
    {
        ...
        {
            FUN_0202D4BC(&UNK_021C59F8->unk470);
            if (FUN_0202D478(&UNK_021C59F8->unk470) > 0)
            {
                FUN_02030C8C(&UNK_021C59F8->unk470,
                    0,
                    UNK_021C59F8->unk460,
                    1,
...
THUMB_FUNC void FUN_02030DFC()
{
    if (UNK_021C59F8 != NULL)
    {
        if (UNK_021C59F8->unk68B == 0)
        {
            ...
            for (r4 = 0; r4 < r7; r4++)
            {
                FUN_0202D4BC(&UNK_021C59F8->unk4E8[r4]);
                if (FUN_0202D478(&UNK_021C59F8->unk4E8[r4]) > 0)
                {

                    FUN_02030C8C(&UNK_021C59F8->unk4E8[r4],
                        (u32)r4,
                        UNK_021C59F8->unk460,
                        0,
...
THUMB_FUNC BOOL FUN_02030E7C(u16 param0)
{
    if (UNK_021C59F8 == NULL)
    {
        return FALSE;
...
THUMB_FUNC void FUN_02031000(u32 param0, u8 *param1, u32 param2)
{
    if (FUN_0202FA28() == 1)
    {
        FUN_0202D684(UNK_021C59F8->unk54C, param0, param1, param2, 1, 0);
        return;
    }

    FUN_0202D684(UNK_021C59F8->unk56C, param0, param1, param2, 1, 0);
}

THUMB_FUNC void FUN_0203105C(u32 param0, u8 *param1, u32 param2)
{
    FUN_0202D684(UNK_021C59F8->unk54C, param0, param1, param2, 0, 0);
}
...
THUMB_FUNC void FUN_02031088()
{
    if (UNK_021C59F8 != NULL)
    {
        ...
        else
        {
            ...
            if (FUN_0202FA28() == 1)
            {
                res = FUN_020311D0(0xb, &UNK_021C59F8->unk67C);
            }
            else
            {
                res = FUN_02030BC4(0xb, &UNK_021C59F8->unk67C, 1);
            }
        ...
        if (FUN_020311D0(0xc, &UNK_021C59F8->unk67C) != 0)
        {
            FUN_0202F9E0(UNK_021C59F8->unk67C);
...
#pragma unused(param0)
#pragma unused(param1)
    if (FUN_02031190() == 0 && UNK_021C59F8->unk67B == 2)
    {
        FUN_0202F9E0(*param2);
        UNK_021C59F8->unk67B = 0;
    }
...
{
    FUN_0202D830(UNK_021C59F8->unk56C, param0);
}

THUMB_FUNC u32 FUN_02031370()
{
    return FUN_0202D4E4(UNK_021C59F8->unk56C);
}

THUMB_FUNC u32 FUN_02031388()
{
    return FUN_0202D4E4(UNK_021C59F8->unk54C);
}
