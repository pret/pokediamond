...
const struct UnkStruct_020FB788 UNK_020FB788[] = {
    ...
    { MON_DATA_MULTI_ABILITY_RIBBON,       96,  0, RIBBON_MULTI_ABILITY,       129         },
    { MON_DATA_PAIR_ABILITY_RIBBON,        97,  0, RIBBON_PAIR_ABILITY,        130         },
    { MON_DATA_WORLD_ABILITY_RIBBON,       98,  0, RIBBON_WORLD_ABILITY,       131         },
    { MON_DATA_ALERT_RIBBON,               99,  2, RIBBON_ALERT,               132         },
    { MON_DATA_SHOCK_RIBBON,               100, 0, RIBBON_SHOCK,               133         },
    { MON_DATA_DOWNCAST_RIBBON,            101, 1, RIBBON_DOWNCAST,            134         },
    { MON_DATA_CARELESS_RIBBON,            102, 2, RIBBON_CARELESS,            135         },
    { MON_DATA_RELAX_RIBBON,               103, 3, RIBBON_RELAX,               136         },
    { MON_DATA_SNOOZE_RIBBON,              104, 0, RIBBON_SNOOZE,              137         },
    { MON_DATA_SMILE_RIBBON,               105, 2, RIBBON_SMILE,               138         },
    { MON_DATA_GORGEOUS_RIBBON,            106, 1, RIBBON_GORGEOUS,            139         },
    { MON_DATA_ROYAL_RIBBON,               107, 3, RIBBON_ROYAL,               140         },
    { MON_DATA_GORGEOUS_ROYAL_RIBBON,      108, 0, RIBBON_GORGEOUS_ROYAL,      141         },
    { MON_DATA_FOOTPRINT_RIBBON,           109, 0, RIBBON_FOOTPRINT,           142         },
    { MON_DATA_RECORD_RIBBON,              110, 1, RIBBON_RECORD,              143         },
    { MON_DATA_HISTORY_RIBBON,             111, 3, RIBBON_HISTORY,             144         },
    { MON_DATA_LEGEND_RIBBON,              112, 0, RIBBON_LEGEND,              145         },
    { MON_DATA_RED_RIBBON,                 113, 0, RIBBON_RED,                 7 | 0x8000  },
    { MON_DATA_GREEN_RIBBON,               114, 3, RIBBON_GREEN,               8 | 0x8000  },
    { MON_DATA_BLUE_RIBBON,                115, 1, RIBBON_BLUE,                9 | 0x8000  },
    { MON_DATA_FESTIVAL_RIBBON,            116, 1, RIBBON_FESTIVAL,            10 | 0x8000 },
    { MON_DATA_CARNIVAL_RIBBON,            117, 0, RIBBON_CARNIVAL,            11 | 0x8000 },
    { MON_DATA_CLASSIC_RIBBON,             118, 1, RIBBON_CLASSIC,             12 | 0x8000 },
    { MON_DATA_PREMIER_RIBBON,             119, 0, RIBBON_PREMIER,             13 | 0x8000 }
};
