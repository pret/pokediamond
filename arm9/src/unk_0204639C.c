...
{
    GF_ASSERT(fieldSystem->unk10 == NULL);
    fieldSystem->unk10 = FUN_0204639C(fieldSystem, r4, r6);
}
...
{
    struct UnkStruct_0204639C * r0 = FUN_0204639C(r4->fieldSystem, r1, r2);
    r0->unk0 = r4;
    r4->fieldSystem->unk10 = r0;
}
...
{
    struct FieldSystem *fieldSystem = FUN_02046528(r4);
...
struct FieldSystem *FUN_02046528(struct UnkStruct_0204639C * r0)
{
    return r0->fieldSystem;
}
