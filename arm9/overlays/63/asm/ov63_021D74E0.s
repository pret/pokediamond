	...
	thumb_func_start ov63_021D74E0
ov63_021D74E0: ; 0x021D74E0
	push {r4, lr}
	...
	add r0, r4, #0
	bl ov63_021D7880
	ldr r0, _021D7598 ; =ov63_021D782C
	add r1, r4, #0
	bl Main_SetVBlankIntrCB
	bl GfGfx_BothDispOn
	mov r0, #1
...
_021D7598: .word ov63_021D782C
	thumb_func_end ov63_021D74E0

	thumb_func_start ov63_021D759C
ov63_021D759C: ; 0x021D759C
	push {r3, r4, r5, r6, lr}
	sub sp, #0xc
	add r5, r1, #0
...
_021D779C:
	...
	pop {r3, r4, r5, r6, pc}
	nop
_021D77A4: .word gSystem
_021D77A8: .word 0x00000495
_021D77AC: .word 0x000005F4
_021D77B0: .word 0x00007FFF
	thumb_func_end ov63_021D759C

	thumb_func_start ov63_021D77B4
ov63_021D77B4: ; 0x021D77B4
...
_021D780A:
	mov r0, #0
	bl sub_0200415C
	ldr r0, _021D7824 ; =SDK_OVERLAY_OVERLAY_63_ID
	ldr r1, _021D7828 ; =ov63_021DBE18
	bl RegisterMainOverlay
_021D7818:
	mov r0, #1
...
_021D7824: .word SDK_OVERLAY_OVERLAY_63_ID
_021D7828: .word ov63_021DBE18
	thumb_func_end ov63_021D77B4

	thumb_func_start ov63_021D782C
ov63_021D782C: ; 0x021D782C
	ldr r3, _021D7834 ; =sub_0201AB60
	ldr r0, [r0, #4]
	bx r3
	nop
_021D7834: .word DoScheduledBgGpuUpdates
	thumb_func_end ov63_021D782C

	thumb_func_start ov63_021D7838
ov63_021D7838: ; 0x021D7838
	push {r4, lr}
	sub sp, #0x28
	ldr r4, _021D7854 ; =ov63_021DBA90
	add r3, sp, #0
	mov r2, #5
_021D7842:
	ldmia r4!, {r0, r1}
	...
	pop {r4, pc}
	.align 2, 0
_021D7854: .word ov63_021DBA90
	thumb_func_end ov63_021D7838

	thumb_func_start ov63_021D7858
ov63_021D7858: ; 0x021D7858
	ldr r0, _021D787C ; =gSystem
	ldr r1, [r0, #0x48]
	mov r0, #1
	and r0, r1
	cmp r0, #1
...
_021D7878:
	...
	bx lr
	.align 2, 0
_021D787C: .word gSystem
	thumb_func_end ov63_021D7858

	thumb_func_start ov63_021D7880
ov63_021D7880: ; 0x021D7880
	push {r4, lr}
	sub sp, #8
	add r4, r0, #0
	mov r0, #4
...
_021D78AC: .word 0x04000008
	thumb_func_end ov63_021D7880

	thumb_func_start ov63_021D78B0
ov63_021D78B0: ; 0x021D78B0
	ldr r3, _021D78B8 ; =sub_020223BC
	ldr r0, [r0, #8]
	bx r3
	nop
_021D78B8: .word sub_020223BC
	thumb_func_end ov63_021D78B0

	thumb_func_start ov63_021D78BC
ov63_021D78BC: ; 0x021D78BC
	push {r3, r4, r5, r6, r7, lr}
	sub sp, #0x18
	add r4, r3, #0
	add r5, r0, #0
	...
	stmia r4!, {r0, r1}
	ldr r0, [r6]
	ldr r6, _021D796C ; =ov63_021DB9A8
	str r0, [r4]
	add r4, r5, #0
	ldmia r6!, {r0, r1}
	add r4, #0x84
	...
	pop {r3, r4, r5, r6, r7, pc}
	nop
_021D796C: .word ov63_021DB9A8
	thumb_func_end ov63_021D78BC

	thumb_func_start ov63_021D7970
ov63_021D7970: ; 0x021D7970
	push {r4, lr}
	add r4, r0, #0
	ldr r1, [r4, #0x64]
	add r0, #0x68
	...
	thumb_func_start ov63_021D798C
ov63_021D798C: ; 0x021D798C
	push {r4, r5, lr}
	sub sp, #0x24
	ldr r5, _021D7A44 ; =ov63_021DBA6C
	add r4, r0, #0
	add r3, sp, #0
	mov r2, #4
_021D7998:
...
_021D7A3E:
	...
	pop {r4, r5, pc}
	nop
_021D7A44: .word ov63_021DBA6C
	thumb_func_end ov63_021D798C

	thumb_func_start ov63_021D7A48
ov63_021D7A48: ; 0x021D7A48
	push {r3, r4, r5, lr}
	sub sp, #0xb8
	add r4, r0, #0
	ldr r0, [r4]
	bl BgConfig_Alloc
	add r3, sp, #0xa8
	ldr r5, _021D7B80 ; =ov63_021DB9B4
	str r0, [r4, #4]
	add r2, r3, #0
	ldmia r5!, {r0, r1}
	stmia r3!, {r0, r1}
	...
	ldr r5, _021D7B84 ; =ov63_021DB9E0
	add r3, sp, #0x8c
	ldmia r5!, {r0, r1}
	add r2, r3, #0
	stmia r3!, {r0, r1}
	...
	ldr r5, _021D7B88 ; =ov63_021DB9C4
	add r3, sp, #0x70
	ldmia r5!, {r0, r1}
	add r2, r3, #0
	stmia r3!, {r0, r1}
	...
	mov r3, #0
	bl InitBgFromTemplate
	ldr r5, _021D7B8C ; =ov63_021DBA50
	add r3, sp, #0x54
	ldmia r5!, {r0, r1}
	add r2, r3, #0
	stmia r3!, {r0, r1}
	...
	mov r3, #0
	bl InitBgFromTemplate
	ldr r5, _021D7B90 ; =ov63_021DBA34
	add r3, sp, #0x38
	ldmia r5!, {r0, r1}
	add r2, r3, #0
	stmia r3!, {r0, r1}
	...
	mov r3, #0
	bl InitBgFromTemplate
	ldr r5, _021D7B94 ; =ov63_021DB9FC
	add r3, sp, #0x1c
	ldmia r5!, {r0, r1}
	add r2, r3, #0
	stmia r3!, {r0, r1}
	...
	mov r3, #0
	bl InitBgFromTemplate
	ldr r5, _021D7B98 ; =ov63_021DBA18
	add r3, sp, #0
	ldmia r5!, {r0, r1}
	add r2, r3, #0
	stmia r3!, {r0, r1}
	...
	pop {r3, r4, r5, pc}
	nop
_021D7B80: .word ov63_021DB9B4
_021D7B84: .word ov63_021DB9E0
_021D7B88: .word ov63_021DB9C4
_021D7B8C: .word ov63_021DBA50
_021D7B90: .word ov63_021DBA34
_021D7B94: .word ov63_021DB9FC
_021D7B98: .word ov63_021DBA18
	thumb_func_end ov63_021D7A48

	thumb_func_start ov63_021D7B9C
ov63_021D7B9C: ; 0x021D7B9C
	push {r4, lr}
	add r4, r0, #0
	mov r0, #1
	mov r1, #0
	...
	thumb_func_start ov63_021D7C18
ov63_021D7C18: ; 0x021D7C18
	push {r4, r5, r6, lr}
	sub sp, #8
	add r5, r0, #0
	add r6, r1, #0
...
_021D7D70: .word gSystem + 0x60
	thumb_func_end ov63_021D7C18

	thumb_func_start ov63_021D7D74
ov63_021D7D74: ; 0x021D7D74
	push {r4, r5, r6, r7, lr}
	sub sp, #0xc
	add r4, r0, #0
	add r7, r1, #0
...
_021D824E:
	...
	add sp, #0xc
	pop {r4, r5, r6, r7, pc}
	thumb_func_end ov63_021D7D74

	thumb_func_start ov63_021D8260
ov63_021D8260: ; 0x021D8260
	push {r3, r4, r5, lr}
	add r5, r0, #0
	ldr r0, [r5]
	mov r4, #0
...
_021D835C: .word 0x00007FFF
	thumb_func_end ov63_021D8260

	thumb_func_start ov63_021D8360
ov63_021D8360: ; 0x021D8360
	push {r4, r5, r6, lr}
	add r5, r0, #0
	add r0, #0xa0
	ldr r0, [r0]
...
_021D83A4: .word gSystem + 0x60
	thumb_func_end ov63_021D8360

	thumb_func_start ov63_021D83A8
ov63_021D83A8: ; 0x021D83A8
	push {r3, r4, r5, r6, r7, lr}
	sub sp, #0x20
	add r5, r0, #0
	mov r0, #0
...
_021D844C:
	...
	add r1, r6, #0
	add r4, r0, #0
	ldr r2, _021D85D0 ; =ov63_021DB9A0
	add r0, r5, #0
	add r1, #0xac
	bl AddWindow
	mov r1, #0
...
_021D85D0: .word ov63_021DB9A0
_021D85D4: .word 0x00010100
	thumb_func_end ov63_021D83A8

	thumb_func_start ov63_021D85D8
ov63_021D85D8: ; 0x021D85D8
	push {r3, r4, r5, r6, r7, lr}
	sub sp, #0x10
	add r2, #0xa8
	add r7, r0, #0
...
_021D8640: .word gGameVersion
	thumb_func_end ov63_021D85D8

	thumb_func_start ov63_021D8644
ov63_021D8644: ; 0x021D8644
...
_021D864C: .word RemoveWindow
	thumb_func_end ov63_021D8644

	thumb_func_start ov63_021D8650
ov63_021D8650: ; 0x021D8650
	push {r4, lr}
...
_021D86DC: .word 0x00000116
	thumb_func_end ov63_021D8650

	thumb_func_start ov63_021D86E0
ov63_021D86E0: ; 0x021D86E0
	push {r3, r4, r5, lr}
	sub sp, #0x18
	add r4, r0, #0
