	...
	thumb_func_start ov60_021D74E0
ov60_021D74E0: ; 0x021D74E0
	push {r3, r4, r5, lr}
	add r4, r0, #0
...
_021D75AC: .word 0xFFFF83FF
	thumb_func_end ov60_021D74E0

	thumb_func_start ov60_021D75B0
ov60_021D75B0: ; 0x021D75B0
	push {r3, r4, r5, lr}
	add r5, r0, #0
...
_021D76B4: .word 0xFFFF83FF
	thumb_func_end ov60_021D75B0

	thumb_func_start ov60_021D76B8
ov60_021D76B8: ; 0x021D76B8
	push {r3, r4, lr}
	sub sp, #0xc
	bl OverlayManager_GetData
	add r4, r0, #0
...
_021D77A0:
	...
	pop {r3, r4, pc}
	.align 2, 0
_021D77AC: .word gSystem
_021D77B0: .word 0x0000061B
	thumb_func_end ov60_021D76B8

	thumb_func_start ov60_021D77B4
ov60_021D77B4: ; 0x021D77B4
	push {r4, lr}
	sub sp, #0x28
...
_021D77BE:
	...
	pop {r4, pc}
	.align 2, 0
_021D77D0: .word ov60_021D8140
	thumb_func_end ov60_021D77B4

	thumb_func_start ov60_021D77D4
ov60_021D77D4: ; 0x021D77D4
	push {r4, lr}
	sub sp, #8
	add r4, r0, #0
	ldr r0, [r4, #0x10]
...
_021D7830: .word 0x00003FF8
	thumb_func_end ov60_021D77D4

	thumb_func_start ov60_021D7834
ov60_021D7834: ; 0x021D7834
	push {r4, lr}
	add r4, r0, #0
	ldr r1, [r4, #8]
	cmp r1, #0
...
_021D78A2:
	...
	bl sub_02033F20
	ldr r0, _021D78E4 ; =ov60_021D77D4
	add r1, r4, #0
	bl Main_SetVBlankIntrCB
	mov r0, #0
	str r0, [r4, #8]
...
_021D78E4: .word ov60_021D77D4
	thumb_func_end ov60_021D7834

	thumb_func_start ov60_021D78E8
ov60_021D78E8: ; 0x021D78E8
...
_021D798C: .word 0x04001000
	thumb_func_end ov60_021D78E8

	thumb_func_start ov60_021D7990
ov60_021D7990: ; 0x021D7990
	push {r3, r4, r5, r6, r7, lr}
	sub sp, #0x80
	add r6, r0, #0
	ldr r0, [r6]
...
_021D79C6:
	...
	pop {r3, r4, r5, r6, r7, pc}
	.align 2, 0
_021D7A08: .word ov60_021D8114
_021D7A0C: .word ov60_021D8168
_021D7A10: .word ov60_021D8104
	thumb_func_end ov60_021D7990

	thumb_func_start ov60_021D7A14
ov60_021D7A14: ; 0x021D7A14
	push {r4, lr}
	add r4, r0, #0
	ldr r0, [r4, #0x14]
	mov r1, #4
	...
	thumb_func_start ov60_021D7A40
ov60_021D7A40: ; 0x021D7A40
	push {r3, r4, r5, r6, lr}
	sub sp, #0x24
	add r5, r0, #0
	ldr r1, [r5]
...
_021D7CD0: .word 0x0000023B
	thumb_func_end ov60_021D7BA4

	thumb_func_start ov60_021D7CD4
ov60_021D7CD4: ; 0x021D7CD4
	push {r3, r4, r5, r6, r7, lr}
	add r5, r0, #0
	add r0, #0x3c
	mov r1, #0
...
_021D7CF0:
	...
	blo _021D7CF0
	pop {r3, r4, r5, r6, r7, pc}
	thumb_func_end ov60_021D7CD4

	thumb_func_start ov60_021D7D18
ov60_021D7D18: ; 0x021D7D18
	push {r3, r4, r5, r6, r7, lr}
	sub sp, #0x10
	add r6, r0, #0
	ldr r1, [r6]
...
_021D7DF4: .word 0x0001020F
	thumb_func_end ov60_021D7D18

	thumb_func_start ov60_021D7DF8
ov60_021D7DF8: ; 0x021D7DF8
	push {r3, r4, r5, r6, r7, lr}
	sub sp, #8
	mov r5, #0
	add r6, r0, #0
...
_021D7E44:
	...
	pop {r3, r4, r5, r6, r7, pc}
	nop
_021D7E9C: .word ov60_021D8124
_021D7EA0: .word 0x00000106
	thumb_func_end ov60_021D7DF8

	thumb_func_start ov60_021D7EA4
ov60_021D7EA4: ; 0x021D7EA4
	push {r4, r5, r6, r7, lr}
	sub sp, #0x24
	str r0, [sp, #0x10]
	lsl r0, r1, #4
...
_021D8002:
	...
	pop {r4, r5, r6, r7, pc}
	.align 2, 0
_021D8010: .word ov60_021D80FC
_021D8014: .word 0x0003040F
_021D8018: .word 0x0001020F
	thumb_func_end ov60_021D7EA4

	thumb_func_start ov60_021D801C
ov60_021D801C: ; 0x021D801C
	push {r3, r4, r5, lr}
	add r5, r0, #0
	ldr r0, [r5, #0x10]
	add r1, r5, #0
...
_021D80F8: .word gSystem
	thumb_func_end ov60_021D801C

	.rodata
	.global ov60_021D80FC
ov60_021D80FC: ; 0x021D80FC
	.byte 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00

	.global ov60_021D8104
ov60_021D8104: ; 0x021D8104
	.byte 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x04, 0x00, 0x00, 0x00

	.global ov60_021D8114
ov60_021D8114: ; 0x021D8114
	.byte 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00

	.global ov60_021D8124
ov60_021D8124: ; 0x021D8124
