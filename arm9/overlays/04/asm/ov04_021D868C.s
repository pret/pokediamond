	...
	thumb_func_start ov04_021D868C
ov04_021D868C: ; 0x021D868C
	push {r3, r4, r5, lr}
	bl MIC_Init
	bl PM_Init
	mov r0, #1
	...
	mov r0, #3
	bl PM_SetAmpGain
	ldr r0, _021D8718 ; =ov04_0220FBC8
	mov r2, #0
	ldr r1, [r0, #4]
...
_021D86CE:
	...
	add r0, r1, r0
	bl NNS_SndStrmInit
	ldr r1, _021D8718 ; =ov04_0220FBC8
	mov r0, #0
	ldr r2, [r1, #4]
	mov r1, #0xb1
	lsl r1, r1, #6
	...
	pop {r3, r4, r5, pc}
	nop
_021D8718: .word ov04_0220FBC8
_021D871C: .word 0x00003584
_021D8720: .word 0x00003598
_021D8724: .word 0x000035B8
_021D8728: .word 0x00003504

	thumb_func_start ov04_021D872C
ov04_021D872C: ; 0x021D872C
	bx lr
	.align 2, 0

	thumb_func_start ov04_021D8730
ov04_021D8730: ; 0x021D8730
	push {r4, r5, r6, lr}
	add r6, r2, #0
	add r5, r3, #0
	ldr r4, [sp, #0x14]
	...
	pop {r4, r5, r6, pc}
_021D8748:
	ldr r0, _021D87B8 ; =ov04_0220FBC8
	ldr r2, [r0, #4]
	...
	add r0, r0, #3
	add r0, r2, r0
	ldr r1, _021D87C0 ; =ov04_021D872C
	mov r2, #0
...
_021D87A2:
	...
	pop {r4, r5, r6, pc}
	.align 2, 0
_021D87B8: .word ov04_0220FBC8
_021D87BC: .word 0x00003565
_021D87C0: .word ov04_021D872C
_021D87C4: .word 0x027FFFA8
_021D87C8: .word 0x000034FC
_021D87CC: .word 0x00003564

	thumb_func_start ov04_021D87D0
ov04_021D87D0: ; 0x021D87D0
	push {r4, lr}
	ldr r1, _021D8810 ; =ov04_0220FBC8
	ldr r2, [r1, #4]
...
_021D87EA:
	...
	pop {r4, pc}
_021D87FE:
	ldr r0, _021D8810 ; =ov04_0220FBC8
	ldr r1, [r0, #4]
...
_021D880A:
	...
	pop {r4, pc}
	nop
_021D8810: .word ov04_0220FBC8
_021D8814: .word 0x00003560

	thumb_func_start ov04_021D8818
ov04_021D8818: ; 0x021D8818
	push {r3, lr}
	ldr r0, _021D8858 ; =ov04_0220FBC8
	ldr r1, [r0, #4]
...
_021D8852:
	...
	pop {r3, pc}
	nop
_021D8858: .word ov04_0220FBC8
_021D885C: .word 0x00003560

	thumb_func_start ov04_021D8860
ov04_021D8860: ; 0x021D8860
	push {r4, lr}
	add r4, r2, #0
	cmp r1, #0xc
	bhi _021D8902
...
_021D888E:
	ldr r0, _021D8904 ; =ov04_0220FBC8
	ldr r2, [r0, #4]
...
_021D8902:
	pop {r4, pc}
	.align 2, 0
_021D8904: .word ov04_0220FBC8
_021D8908: .word 0x00003560
_021D890C: .word 0x000034F8

	thumb_func_start ov04_021D8910
ov04_021D8910: ; 0x021D8910
	push {r4, lr}
	ldr r1, _021D893C ; =ov04_0220FBC8
	add r4, r0, #0
	ldr r2, [r1, #4]
	...
	add r0, r4, #0
	bl sub_020ACC84
	ldr r0, _021D893C ; =ov04_0220FBC8
	mov r2, #0
	ldr r1, [r0, #4]
...
_021D8936:
	...
	pop {r4, pc}
	.align 2, 0
_021D893C: .word ov04_0220FBC8
_021D8940: .word 0x00003560

	thumb_func_start ov04_021D8944
ov04_021D8944: ; 0x021D8944
	push {r4, r5, r6, lr}
	bl OS_GetTick
	add r4, r0, #0
	ldr r0, _021D8A3C ; =ov04_0220FBC8
	add r5, r1, #0
	ldr r0, [r0, #0xc]
	sub r1, r4, r0
	mov r0, #0xfa
	...
	bl _u32_div_f
	ldr r1, _021D8A3C ; =ov04_0220FBC8
...
_021D8976:
	...
	str r5, [r0, #0x10]
	bl VCT_Main
	ldr r4, _021D8A3C ; =ov04_0220FBC8
...
_021D8A50: .word 0x000034F8
	...
	thumb_func_start ov04_021D8A54
ov04_021D8A54: ; 0x021D8A54
	push {r3, lr}
	ldr r3, _021D8A78 ; =ov04_0220FBC8
	ldr r3, [r3, #4]
	cmp r3, #0
	bne _021D8A62
	mov r0, #0
...
_021D8A72:
	...
	pop {r3, pc}
	nop
_021D8A78: .word ov04_0220FBC8

	thumb_func_start ov04_021D8A7C
ov04_021D8A7C: ; 0x021D8A7C
	push {r4, r5, r6, r7, lr}
	sub sp, #0x34
	ldr r2, _021D8BC8 ; =ov04_0220BAC0
	add r4, r1, #0
	ldrb r3, [r2]
	add r1, sp, #0x10
	add r5, r0, #0
	...
	strb r3, [r1, #1]
	strb r2, [r1, #2]
	ldr r1, _021D8BCC ; =ov04_0220FBC8
	ldr r1, [r1, #4]
	cmp r1, #0
	bne _021D8ACA
	...
	str r5, [r0, r1]
	add r0, r1, #0
	ldr r5, _021D8BD4 ; =ov04_0220FBE0
	ldr r3, [r2, #4]
	sub r0, #0x40
	str r5, [r3, r0]
	ldr r0, [r2, #4]
	...
	bl ov04_021D868C
_021D8ACA:
	ldr r5, _021D8BCC ; =ov04_0220FBC8
	mov r7, #0x11
	ldr r0, [r5, #4]
	...
	mov r0, #2
	str r0, [sp, #4]
	ldr r0, _021D8BE0 ; =ov04_021D8730
	add r1, r5, #0
	str r0, [sp, #8]
	mov r0, #0xd3
	ldr r2, [r1, #4]
	...
	add r1, sp, #0x10
	strb r0, [r1, #0x10]
	ldr r0, _021D8BE8 ; =ov04_021D8860
	str r0, [sp, #0x2c]
	add r0, r5, #0
	str r0, [sp, #0x30]
	ldr r0, _021D8BCC ; =ov04_0220FBC8
	ldr r0, [r0, #4]
	str r0, [sp, #0x24]
	mov r0, #0x8f
	lsl r0, r0, #6
	...
	pop {r4, r5, r6, r7, pc}
	nop
_021D8BC8: .word ov04_0220BAC0
_021D8BCC: .word ov04_0220FBC8
_021D8BD0: .word 0x000035DC
_021D8BD4: .word ov04_0220FBE0
_021D8BD8: .word 0x00003568
_021D8BDC: .word 0x00003504
_021D8BE0: .word ov04_021D8730
_021D8BE4: .word 0x000034F8
_021D8BE8: .word ov04_021D8860
_021D8BEC: .word 0x000034FC

	thumb_func_start ov04_021D8BF0
ov04_021D8BF0: ; 0x021D8BF0
	ldr r0, _021D8BFC ; =ov04_0220FBC8
	...
	bx r3
	.align 2, 0
_021D8BFC: .word ov04_0220FBC8
_021D8C00: .word NNS_SndStrmStart
_021D8C04: .word 0x00003504

	thumb_func_start ov04_021D8C08
ov04_021D8C08: ; 0x021D8C08
	push {r3, lr}
	ldr r0, _021D8C50 ; =ov04_0220FBC8
...
_021D8C4E:
	pop {r3, pc}
	.align 2, 0
_021D8C50: .word ov04_0220FBC8
_021D8C54: .word 0x00003560

	thumb_func_start ov04_021D8C58
ov04_021D8C58: ; 0x021D8C58
	ldr r1, _021D8C64 ; =ov04_0220FBC8
	ldr r2, [r1, #4]
	ldr r1, _021D8C68 ; =0x000034C4
	str r0, [r2, r1]
	bx lr
	nop
_021D8C64: .word ov04_0220FBC8
_021D8C68: .word 0x000034C4

	thumb_func_start ov04_021D8C6C
ov04_021D8C6C: ; 0x021D8C6C
	push {r4, lr}
	...
	bl VCT_Cleanup
	ldr r1, _021D8CBC ; =ov04_0220FBC8
	mov r0, #0x35
	ldr r2, [r1, #4]
	lsl r0, r0, #8
	ldr r0, [r2, r0]
...
_021D8CBA:
	pop {r4, pc}
	.align 2, 0
_021D8CBC: .word ov04_0220FBC8
_021D8CC0: .word 0x000034C4
_021D8CC4: .word 0x00003504

	thumb_func_start ov04_021D8CC8
ov04_021D8CC8: ; 0x021D8CC8
	push {r3, lr}
	sub sp, #0x10
	ldr r0, _021D8CEC ; =ov04_0220FBC8
	ldr r0, [r0, #4]
	cmp r0, #0
	beq _021D8CE6
	add r0, sp, #0
...
_021D8CE6:
	...
	pop {r3, pc}
	.align 2, 0
_021D8CEC: .word ov04_0220FBC8

	thumb_func_start ov04_021D8CF0
ov04_021D8CF0: ; 0x021D8CF0
	ldr r0, _021D8CFC ; =ov04_0220FBC8
	mov r2, #1
	ldr r1, [r0, #4]
	...
	bx lr
	.align 2, 0
_021D8CFC: .word ov04_0220FBC8
_021D8D00: .word 0x000034FC

	thumb_func_start ov04_021D8D04
ov04_021D8D04: ; 0x021D8D04
	ldr r0, _021D8D10 ; =ov04_0220FBC8
	mov r2, #0
	ldr r1, [r0, #4]
	...
	bx lr
	.align 2, 0
_021D8D10: .word ov04_0220FBC8
_021D8D14: .word 0x000034FC

	.section .rodata

	.global ov04_0220BAC0
ov04_0220BAC0: ; 0x0220BAC0
	.byte 0x0D, 0x0D, 0x0D

	.section .bss

	.global ov04_0220FBC8
ov04_0220FBC8: ; 0x0220FBC8
	.space 0x18

	.global ov04_0220FBE0
ov04_0220FBE0: ; 0x0220FBE0
	.space 0x880
