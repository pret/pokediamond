	...
	thumb_func_start ov77_021D74E0
ov77_021D74E0: ; 0x021D74E0
	push {r3, r4, r5, lr}
	add r4, r0, #0
	mov r0, #0
	add r1, r0, #0
...
_021D7600: .word gSystem + 0x60
	thumb_func_end ov77_021D74E0

	thumb_func_start ov77_021D7604
ov77_021D7604: ; 0x021D7604
	push {r4, r5, r6, r7, lr}
	sub sp, #0x14
	add r5, r1, #0
...
_021D7978: .word ov77_021D8F64
_021D797C: .word 0x0000C024
_021D7980: .word ov77_021D8F18
_021D7984: .word ov77_021D8FB4
_021D7988: .word 0x0000C054
_021D798C: .word 0x000005DC
_021D7990: .word ov77_021D8F38
...
_021D79A8: .word ov77_021D8F20
_021D79AC: .word ov77_021D8FD4
...
_021D7BA8: .word 0x0000C060
	thumb_func_end ov77_021D7604

	thumb_func_start ov77_021D7BAC
ov77_021D7BAC: ; 0x021D7BAC
	push {r4, r5, r6, lr}
	add r6, r0, #0
	bl OverlayManager_GetData
	add r4, r0, #0
...
_021D7C20: .word gSystem + 0x60
	thumb_func_end ov77_021D7BAC

	thumb_func_start ov77_021D7C24
ov77_021D7C24: ; 0x021D7C24
	push {r4, lr}
	sub sp, #0x28
...
_021D7C2E:
	...
	pop {r4, pc}
	.align 2, 0
_021D7C40: .word ov77_021D9084
	thumb_func_end ov77_021D7C24

	thumb_func_start ov77_021D7C44
ov77_021D7C44: ; 0x021D7C44
	push {r4, lr}
	sub sp, #0x10
	...
	pop {r4, pc}
	.align 2, 0
_021D7C60: .word ov77_021D8F54
	thumb_func_end ov77_021D7C44

	thumb_func_start ov77_021D7C64
ov77_021D7C64: ; 0x021D7C64
	push {r4, r5, r6, r7, lr}
	sub sp, #0x24
	mov r2, #0
	str r0, [sp, #8]
...
_021D7D52:
	...
	pop {r4, r5, r6, r7, pc}
	.align 2, 0
	thumb_func_end ov77_021D7C64

	thumb_func_start ov77_021D7D58
ov77_021D7D58: ; 0x021D7D58
...
_021D7D9C:
	...
	nop
_021D7DC8: .word ov77_021D903C
	thumb_func_end ov77_021D7D58

	thumb_func_start ov77_021D7DCC
ov77_021D7DCC: ; 0x021D7DCC
	push {r4, r5, r6, r7}
	ldr r1, [r0, #0xc]
	mov r4, #0
	cmp r1, #0
...
_021D7E18: .word 0x0000C2B8
	thumb_func_end ov77_021D7DCC

	thumb_func_start ov77_021D7E1C
ov77_021D7E1C: ; 0x021D7E1C
	ldr r3, _021D7E20 ; =sub_02088D20
	bx r3
	.align 2, 0
_021D7E20: .word sub_02088D20
	thumb_func_end ov77_021D7E1C

	thumb_func_start ov77_021D7E24
ov77_021D7E24: ; 0x021D7E24
	push {r4, lr}
	sub sp, #0x18
	add r4, r0, #0
...
_021D7F38: .word 0x0000C310
	thumb_func_end ov77_021D7E24

	thumb_func_start ov77_021D7F3C
ov77_021D7F3C: ; 0x021D7F3C
	push {r3, r4, r5, r6, r7, lr}
	mov lr, r0
...
_021D7FA8: .word 0x0000FFFF
	thumb_func_end ov77_021D7F3C

	thumb_func_start ov77_021D7FAC
ov77_021D7FAC: ; 0x021D7FAC
	push {r3, r4, r5, lr}
	sub sp, #0x18
	add r5, r0, #0
...
_021D820C: .word ov77_021D8F7C
_021D8210: .word ov77_021D8F98
_021D8214: .word 0x000001E2
_021D8218: .word 0x000001D9
_021D821C: .word 0x00004753
_021D8220: .word ov77_021D8F40
...
_021D823C: .word ov77_021D8F30
_021D8240: .word 0x0000C034
_021D8244: .word 0x0000C060
	thumb_func_end ov77_021D7FAC

	thumb_func_start ov77_021D8248
ov77_021D8248: ; 0x021D8248
	push {r4, lr}
	add r4, r0, #0
...
_021D8290: .word 0x0000C010
	thumb_func_end ov77_021D8248

	thumb_func_start ov77_021D8294
ov77_021D8294: ; 0x021D8294
	push {r3, r4, r5, r6, lr}
	sub sp, #0xc
	add r5, r0, #0
...
_021D8358: .word gSystem
	thumb_func_end ov77_021D8294

	thumb_func_start ov77_021D835C
ov77_021D835C: ; 0x021D835C
	push {r3, lr}
	cmp r2, #0
	bne _021D8368
...
_021D836C: .word 0x000005DC
	thumb_func_end ov77_021D835C

	thumb_func_start ov77_021D8370
ov77_021D8370: ; 0x021D8370
	push {r4, r5, r6, r7, lr}
	sub sp, #0x24
	add r5, r0, #0
...
_021D83B2:
	...
	ldr r0, [sp]
	str r0, [sp, #0x10]
	ldr r0, _021D840C ; =ov77_021D835C
	str r0, [sp, #8]
	ldr r3, [r5]
	add r0, r2, #0
	lsl r3, r3, #0x18
...
_021D840C: .word ov77_021D835C
_021D8410: .word 0x0000C054
_021D8414: .word 0x000001D9
	thumb_func_end ov77_021D8370

	thumb_func_start ov77_021D8418
ov77_021D8418: ; 0x021D8418
	push {r4, r5, r6, r7, lr}
	sub sp, #0x2c
	add r5, r0, #0
...
_021D8462:
	...
	ldr r0, [sp]
	str r0, [sp, #0x18]
	ldr r0, _021D84CC ; =ov77_021D835C
	str r0, [sp, #0x10]
	ldr r3, [r5]
	add r0, r2, #0
	lsl r3, r3, #0x18
...
_021D84CC: .word ov77_021D835C
_021D84D0: .word 0x0000C054
_021D84D4: .word 0x000001D9
	thumb_func_end ov77_021D8418

	thumb_func_start ov77_021D84D8
ov77_021D84D8: ; 0x021D84D8
	push {r4, lr}
	add r4, r0, #0
...
_021D850C: .word 0x0000C058
	thumb_func_end ov77_021D84D8

	thumb_func_start ov77_021D8510
ov77_021D8510: ; 0x021D8510
	push {r3, r4, r5, r6, lr}
	sub sp, #0xc
	add r5, r0, #0
	mov r0, #1
...
_021D85DC: .word 0x0000C060
	thumb_func_end ov77_021D8510

	thumb_func_start ov77_021D85E0
ov77_021D85E0: ; 0x021D85E0
	push {r3, r4, r5, r6, r7, lr}
	sub sp, #0x10
	add r5, r0, #0
	str r1, [sp, #0xc]
...
_021D868C: .word ov77_021D8F28
_021D8690: .word 0x0000C044
_021D8694: .word 0x000001D9
	thumb_func_end ov77_021D85E0

	thumb_func_start ov77_021D8698
ov77_021D8698: ; 0x021D8698
	push {r4, lr}
	add r4, r0, #0
...
_021D86B0: .word 0x0000C044
	thumb_func_end ov77_021D8698

	thumb_func_start ov77_021D86B4
ov77_021D86B4: ; 0x021D86B4
	push {r3, r4, r5, r6, r7, lr}
	sub sp, #0x20
	add r5, r0, #0
...
_021D8810: .word 0x0000C060
	thumb_func_end ov77_021D86B4

	thumb_func_start ov77_021D8814
ov77_021D8814: ; 0x021D8814
	push {r4, lr}
	add r4, r0, #0
	ldr r2, [r4]
	mov r0, #0x81
...
_021D88CC: .word 0x0000C178
	thumb_func_end ov77_021D8814

	thumb_func_start ov77_021D88D0
ov77_021D88D0: ; 0x021D88D0
	push {r4, lr}
	add r4, r0, #0
...
_021D8910: .word 0x0000C0CC
	thumb_func_end ov77_021D88D0

	thumb_func_start ov77_021D8914
ov77_021D8914: ; 0x021D8914
	push {r4, r5}
...
_021D896C: .word 0x0000C29C
	thumb_func_end ov77_021D8914

	thumb_func_start ov77_021D8970
ov77_021D8970: ; 0x021D8970
	push {r3, r4, r5, r6, r7, lr}
	sub sp, #0x20
...
_021D89D6:
	...
	pop {r3, r4, r5, r6, r7, pc}
	.align 2, 0
_021D89E4: .word ov77_021D8F48
_021D89E8: .word 0x0000C2CC
_021D89EC: .word 0x000005C1
_021D89F0: .word 0x0000C2F4
	thumb_func_end ov77_021D8970

	thumb_func_start ov77_021D89F4
ov77_021D89F4: ; 0x021D89F4
	push {r4, lr}
...
_021D8A2C: .word 0xFFFFF001
	thumb_func_end ov77_021D89F4

	thumb_func_start ov77_021D8A30
ov77_021D8A30: ; 0x021D8A30
	push {r4, r5, lr}
	sub sp, #0x24
	add r4, r1, #0
	ldr r1, [r4, #4]
...
_021D8AA4: .word FX_SinCosTable_
	thumb_func_end ov77_021D8A30

	thumb_func_start ov77_021D8AA8
ov77_021D8AA8: ; 0x021D8AA8
	push {r4, r5, lr}
	sub sp, #0x24
	add r4, r1, #0
	ldr r1, [r4]
...
_021D8B1C: .word FX_SinCosTable_
	thumb_func_end ov77_021D8AA8

	thumb_func_start ov77_021D8B20
ov77_021D8B20: ; 0x021D8B20
	push {r3, r4, r5, r6, r7, lr}
	add r3, r0, #0
...
_021D8CF4: .word 0xFFFFC200
	thumb_func_end ov77_021D8B20

	thumb_func_start ov77_021D8CF8
ov77_021D8CF8: ; 0x021D8CF8
	push {r3, r4, r5, lr}
	add r5, r0, #0
...
_021D8D80: .word 0x0000C2D8
	thumb_func_end ov77_021D8CF8

	thumb_func_start ov77_021D8D84
ov77_021D8D84: ; 0x021D8D84
	push {r3, r4, r5, r6, r7, lr}
	sub sp, #0x70
...
_021D8EDC:
	...
	add sp, #0xc
	pop {r4, r5, r6, r7, pc}
	thumb_func_end ov77_021D8E9C

	thumb_func_start ov77_021D8F04
ov77_021D8F04: ; 0x021D8F04
	push {r3, lr}
	bl ov77_021D7E1C
	cmp r0, #0
	beq _021D8F12
...
_021D8F12:
	...
	pop {r3, pc}
	.align 2, 0
	thumb_func_end ov77_021D8F04

	.rodata
	.global ov77_021D8F18
ov77_021D8F18: ; 0x021D8F18
	.byte 0x06, 0x13, 0x0B, 0x0C, 0x06, 0x04, 0x25, 0x01

	.global ov77_021D8F20
ov77_021D8F20: ; 0x021D8F20
	.byte 0x06, 0x03, 0x02, 0x1A, 0x0E, 0x04, 0x01, 0x00

	.global ov77_021D8F28
ov77_021D8F28: ; 0x021D8F28
	.byte 0x06, 0x02, 0x01, 0x1B, 0x06, 0x04, 0xB3, 0x00

	.global ov77_021D8F30
ov77_021D8F30: ; 0x021D8F30
	.byte 0x02, 0x19, 0x15, 0x06, 0x02, 0x04, 0xCD, 0x01

	.global ov77_021D8F38
ov77_021D8F38: ; 0x021D8F38
	.byte 0x06, 0x19, 0x0D, 0x06, 0x04, 0x04, 0x55, 0x01

	.global ov77_021D8F40
ov77_021D8F40: ; 0x021D8F40
	.byte 0x06, 0x02, 0x13, 0x1B, 0x04, 0x04, 0x6D, 0x01

	.global ov77_021D8F48
ov77_021D8F48: ; 0x021D8F48
	.byte 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80, 0x12, 0x00

	.global ov77_021D8F54
ov77_021D8F54: ; 0x021D8F54
	.byte 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00

	.global ov77_021D8F64
ov77_021D8F64: ; 0x021D8F64
	...
	.global ov77_021D8F7C
ov77_021D8F7C: ; 0x021D8F7C
	.byte 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
	.byte 0x01, 0x00, 0x0E, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00

	.global ov77_021D8F98
ov77_021D8F98: ; 0x021D8F98
	.byte 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
	.byte 0x01, 0x00, 0x0F, 0x01, 0x00, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00

	.global ov77_021D8FB4
ov77_021D8FB4: ; 0x021D8FB4
	.byte 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
	.byte 0x03, 0x00, 0x03, 0x00, 0x00, 0x0C, 0x00, 0x10, 0x2F, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00

	.global ov77_021D8FD4
ov77_021D8FD4: ; 0x021D8FD4
	.byte 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
	.byte 0x00, 0x00, 0x07, 0x00, 0x00, 0x0C, 0x00, 0x10, 0x2F, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00

	.global ov77_021D8FF4
ov77_021D8FF4: ; 0x021D8FF4
	.byte 0x00, 0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
	.byte 0x00, 0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
	.byte 0x00, 0x10, 0x00, 0x00

	.global ov77_021D9018
ov77_021D9018: ; 0x021D9018
	.byte 0x00, 0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
	.byte 0x00, 0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
	.byte 0x00, 0x10, 0x00, 0x00

	.global ov77_021D903C
ov77_021D903C: ; 0x021D903C
	.byte 0x00, 0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
	.byte 0x00, 0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
	.byte 0x00, 0x10, 0x00, 0x00

	.global ov77_021D9060
ov77_021D9060: ; 0x021D9060
	.byte 0x00, 0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
	.byte 0x00, 0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
	.byte 0x00, 0x10, 0x00, 0x00

	.global ov77_021D9084
ov77_021D9084: ; 0x021D9084
