	...
	thumb_func_start ov84_021D74E0
ov84_021D74E0: ; 0x021D74E0
	push {r3, r4, r5, r6, lr}
	sub sp, #0x14
	add r5, r1, #0
	ldr r1, [r5]
...
_021D7516:
	...
	mov r0, #0xe
	bl sub_0200433C
	ldr r0, _021D7694 ; =ov84_021D7958
	add r1, r4, #0
	mov r2, #1
	bl sub_0200CA60
	ldr r1, _021D7698 ; =0x00001230
	str r0, [r4, r1]
	ldr r0, _021D769C ; =ov84_021D7950
	add r1, r4, #0
	bl Main_SetVBlankIntrCB
_021D7618:
	ldr r0, [r5]
...
_021D7684: .word ov84_021DA6C8
_021D7688: .word 0x00001224
_021D768C: .word 0x0000122C
_021D7690: .word 0x000004A2
_021D7694: .word ov84_021D7958
_021D7698: .word 0x00001230
_021D769C: .word ov84_021D7950
_021D76A0: .word 0x00001228
	thumb_func_end ov84_021D74E0

	thumb_func_start ov84_021D76A4
ov84_021D76A4: ; 0x021D76A4
	push {r4, r5, r6, lr}
	add r4, r1, #0
	add r6, r0, #0
	bl OverlayManager_GetData
...
_021D7744: .word 0x00001230
	thumb_func_end ov84_021D76A4

	thumb_func_start ov84_021D7748
ov84_021D7748: ; 0x021D7748
	push {r4, r5, lr}
	sub sp, #0xc
	add r5, r1, #0
	bl OverlayManager_GetData
...
_021D7930: .word ov84_021DA6FC
_021D7934: .word 0x00001228
_021D7938: .word ov84_021DA700
_021D793C: .word 0x00001224
_021D7940: .word ov84_021DA6F4
_021D7944: .word ov84_021DA6F8
_021D7948: .word 0xFFFF1FFF
_021D794C: .word 0x04001000
	thumb_func_end ov84_021D7748

	thumb_func_start ov84_021D7950
ov84_021D7950: ; 0x021D7950
	ldr r3, _021D7954 ; =ov84_021D7CFC
	bx r3
	.align 2, 0
_021D7954: .word ov84_021D7CFC
	thumb_func_end ov84_021D7950

	thumb_func_start ov84_021D7958
ov84_021D7958: ; 0x021D7958
	push {r3, lr}
	add r1, #0xdc
	ldr r0, [r1]
	bl sub_0201FDEC
	...
	pop {r3, pc}
	thumb_func_end ov84_021D7958

	thumb_func_start ov84_021D7968
ov84_021D7968: ; 0x021D7968
	push {r4, r5, r6, r7, lr}
	sub sp, #0xc
	add r4, r0, #0
	mov r0, #0x4b
	...
	pop {r4, r5, r6, r7, pc}
	.align 2, 0
_021D7A60: .word ov84_021DA68C
_021D7A64: .word 0x04000304
_021D7A68: .word 0xFFFF7FFF
_021D7A6C: .word ov84_021DA650
_021D7A70: .word ov84_021DA670
_021D7A74: .word 0x04000050
_021D7A78: .word 0x04001050
_021D7A7C: .word 0x00005EC0
_021D7A80: .word 0xFFFF1FFF
	thumb_func_end ov84_021D7968

	thumb_func_start ov84_021D7A84
ov84_021D7A84: ; 0x021D7A84
	push {r4, lr}
	add r4, r0, #0
	ldr r0, [r4, #4]
	mov r1, #1
	...
	thumb_func_start ov84_021D7AA0
ov84_021D7AA0: ; 0x021D7AA0
	push {r4, lr}
	add r4, r0, #0
	bl ov84_021D7AC8
	add r0, r4, #0
	...
	pop {r4, pc}
	.align 2, 0
	thumb_func_end ov84_021D7AA0

	thumb_func_start ov84_021D7AB8
ov84_021D7AB8: ; 0x021D7AB8
	push {r4, lr}
	add r4, r0, #0
	bl ov84_021D7CD4
	add r0, r4, #0
	bl ov84_021D7BBC
	pop {r4, pc}
	thumb_func_end ov84_021D7AB8

	thumb_func_start ov84_021D7AC8
ov84_021D7AC8: ; 0x021D7AC8
	push {r3, lr}
	bl NNS_G3dInit
	bl G3X_InitMtxStack
...
_021D7B50: .word 0x04000008
	thumb_func_end ov84_021D7AC8

	thumb_func_start ov84_021D7B54
ov84_021D7B54: ; 0x021D7B54
	push {r4, lr}
	sub sp, #0x18
	add r4, r0, #0
	mov r0, #0x4b
...
_021D7BB8: .word 0x00000FA4
	thumb_func_end ov84_021D7B54

	thumb_func_start ov84_021D7BBC
ov84_021D7BBC: ; 0x021D7BBC
...
_021D7CD0: .word 0xFFF8E000
	thumb_func_end ov84_021D7BC8

	thumb_func_start ov84_021D7CD4
ov84_021D7CD4: ; 0x021D7CD4
	push {r4, lr}
	add r4, r0, #0
	add r4, #0x38
	ldr r0, [r4, #4]
...
_021D7CFA:
	...
	thumb_func_start ov84_021D7CFC
ov84_021D7CFC: ; 0x021D7CFC
	push {r3, r4, lr}
	sub sp, #0x4c
	add r4, r0, #0
...
_021D7DF0: .word FX_SinCosTable_
	thumb_func_end ov84_021D7CFC

	thumb_func_start ov84_021D7DF4
ov84_021D7DF4: ; 0x021D7DF4
	push {r4, r5, lr}
	sub sp, #0xc
	add r4, r0, #0
	ldr r0, [r0, #0x38]
...
_021D7ED0:
	...
	pop {r4, r5, pc}
	.align 2, 0
_021D7ED4: .word ov84_021DA648
_021D7ED8: .word 0xFFF8E000
	thumb_func_end ov84_021D7DF4

	thumb_func_start ov84_021D7EDC
ov84_021D7EDC: ; 0x021D7EDC
	push {r4, r5, lr}
	sub sp, #0x14
	add r5, r0, #0
	mov r0, #0x82
...
_021D7F2C:
	...
	pop {r4, r5, pc}
	.align 2, 0
_021D7F84: .word ov84_021DA660
_021D7F88: .word ov84_021DA662
_021D7F8C: .word ov84_021DA664
_021D7F90: .word ov84_021DA666
	thumb_func_end ov84_021D7EDC

	thumb_func_start ov84_021D7F94
ov84_021D7F94: ; 0x021D7F94
	push {r4, lr}
	sub sp, #0x30
	add r4, r0, #0
	bl ov84_021D7EDC
	...
	thumb_func_start ov84_021D8000
ov84_021D8000: ; 0x021D8000
	push {r4, lr}
	add r4, r0, #0
	mov r0, #0x2b
	lsl r0, r0, #4
	...
	pop {r4, pc}
	.align 2, 0
	thumb_func_end ov84_021D8000

	thumb_func_start ov84_021D801C
ov84_021D801C: ; 0x021D801C
	...
	str r0, [r4, #0x20]
	bne _021D8068
	ldr r0, _021D80A4 ; =ov84_021D80B8
	str r0, [r4, #8]
	ldr r0, _021D80A8 ; =ov84_021D80F0
	b _021D806E
_021D8068:
	ldr r0, _021D80AC ; =ov84_021D8104
	str r0, [r4, #8]
	ldr r0, _021D80B0 ; =ov84_021D813C
_021D806E:
	str r0, [r4, #0xc]
	mov r0, #0
	str r0, [r4, #0x28]
	...
	mov r0, #0
	str r0, [r4, #0x10]
	ldr r0, _021D80B4 ; =ov84_021D8150
	add r1, r4, #0
	mov r2, #1
	bl sub_0200CA98
	str r0, [r4, #4]
_021D8090:
	...
	.align 2, 0
_021D8094: .word ov84_021DA6B4
_021D8098: .word ov84_021DA6B8
_021D809C: .word ov84_021DA6BC
_021D80A0: .word ov84_021DA6C0
_021D80A4: .word ov84_021D80B8
_021D80A8: .word ov84_021D80F0
_021D80AC: .word ov84_021D8104
_021D80B0: .word ov84_021D813C
_021D80B4: .word ov84_021D8150
	thumb_func_end ov84_021D801C

	.rodata

	.global ov84_021DA648
ov84_021DA648: ; 0x021DA648
	.byte 0x00, 0x00, 0x01, 0x00, 0x02, 0x00, 0x00, 0x00

	.global ov84_021DA650
ov84_021DA650: ; 0x021DA650
	.byte 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00

	.global ov84_021DA660
ov84_021DA660: ; 0x021DA660
	.byte 0x2F, 0x00

	.global ov84_021DA662
ov84_021DA662: ; 0x021DA662
	.byte 0x30, 0x00

	.global ov84_021DA664
ov84_021DA664: ; 0x021DA664
	.byte 0x2D, 0x00

	.global ov84_021DA666
ov84_021DA666: ; 0x021DA666
	.byte 0x2E, 0x00, 0x33, 0x00, 0x34, 0x00, 0x31, 0x00, 0x32, 0x00

	.global ov84_021DA670
ov84_021DA670: ; 0x021DA670
	.byte 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
	.byte 0x01, 0x00, 0x1F, 0x06, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00

	.global ov84_021DA68C
ov84_021DA68C: ; 0x021DA68C
	...
	.global ov84_021DA6B4
ov84_021DA6B4: ; 0x021DA6B4
	.byte 0x02, 0x00, 0x00, 0x00

	.global ov84_021DA6B8
ov84_021DA6B8: ; 0x021DA6B8
	.byte 0x03, 0x00, 0x00, 0x00

	.global ov84_021DA6BC
ov84_021DA6BC: ; 0x021DA6BC
	.byte 0x0C, 0x00, 0x00, 0x00

	.global ov84_021DA6C0
ov84_021DA6C0: ; 0x021DA6C0
	.byte 0x08, 0x00, 0x00, 0x00, 0x03, 0x00, 0x00, 0x00

	.global ov84_021DA6C8
ov84_021DA6C8: ; 0x021DA6C8
	...
	.global ov84_021DA6F4
ov84_021DA6F4: ; 0x021DA6F4
	.word ov84_021D8874

	.global ov84_021DA6F8
ov84_021DA6F8: ; 0x021DA6F8
	.word ov84_021D88A4

	.global ov84_021DA6FC
ov84_021DA6FC: ; 0x021DA6FC
	.word ov84_021D88DC

	.global ov84_021DA700
ov84_021DA700: ; 0x021DA700
	.word ov84_021D88C8, ov84_021D8A8C, ov84_021D8AAC, ov84_021D8AD4
	.word ov84_021D8AC0, ov84_021D8C54, ov84_021D8CD8, ov84_021D8D0C
	.word ov84_021D8CEC, ov84_021D9394, ov84_021D93B4, ov84_021D93DC
	.word ov84_021D93C8, ov84_021D955C, ov84_021D9594, ov84_021D95CC
	.word ov84_021D95B8, ov84_021D9A54, ov84_021D9A74, ov84_021D9A9C
	.word ov84_021D9A88, ov84_021D9C1C, ov84_021D9C80, ov84_021D9CD4
	.word ov84_021D9CA4
