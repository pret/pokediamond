	...
	thumb_func_start ov05_021DA5B8
ov05_021DA5B8: ; 0x021DA5B8
	push {r3, lr}
	mov r0, #4
	mov r1, #0x28
	bl Heap_AllocAtEnd
	...
	thumb_func_start ov05_021DA5C8
ov05_021DA5C8: ; 0x021DA5C8
	ldr r3, _021DA5CC ; =Heap_Free
	bx r3
	.balign 4, 0
_021DA5CC: .word Heap_Free

	thumb_func_start ov05_021DA5D0
ov05_021DA5D0: ; 0x021DA5D0
	str r0, [r2, #0x14]
	str r1, [r2, #0x18]
	bx lr
	.balign 4, 0

	thumb_func_start ov05_021DA5D8
ov05_021DA5D8: ; 0x021DA5D8
	push {r4, r5, r6, r7, lr}
	sub sp, #0x84
	add r4, r1, #0
	add r5, r0, #0
...
_021DA600:
	ldr r6, _021DA7A4 ; =ov05_021F650C
	add r3, sp, #0x34
	mov r2, #0xa
_021DA606:
	ldmia r6!, {r0, r1}
...
_021DA79E:
	...
	pop {r4, r5, r6, r7, pc}
	.balign 4, 0
_021DA7A4: .word ov05_021F650C
_021DA7A8: .word 0x00000608
_021DA7AC: .word 0x00000605
_021DA7B0: .word 0x00000607

	thumb_func_start ov05_021DA7B4
ov05_021DA7B4: ; 0x021DA7B4
	push {r4, r5, r6, r7, lr}
	sub sp, #0x84
	add r4, r1, #0
	add r5, r0, #0
...
_021DA7DE:
	ldr r6, _021DA9D4 ; =ov05_021F655C
	add r3, sp, #0x34
	mov r2, #0xa
_021DA7E4:
	ldmia r6!, {r0, r1}
...
_021DAA28:
	...
	thumb_func_start ov05_021DAA2C
ov05_021DAA2C: ; 0x021DAA2C
	push {r4, r5, r6, lr}
	add r5, r1, #0
	add r6, r0, #0
	ldrb r0, [r5]
...
_021DAA68:
	...
	thumb_func_start ov05_021DAA6C
ov05_021DAA6C: ; 0x021DAA6C
	cmp r0, #0x46
	beq _021DAA98
...
_021DAAA0: .word 0x000001BA
	...
	thumb_func_start ov05_021DAAA4
ov05_021DAAA4: ; 0x021DAAA4
...
_021DAACE:
	ldr r3, _021DAC68 ; =ov05_021F64FC
	add r2, sp, #0x20
	ldmia r3!, {r0, r1}
	stmia r2!, {r0, r1}
	ldmia r3!, {r0, r1}
...
_021DAC60:
	...
	pop {r3, r4, r5, r6, r7, pc}
	nop
_021DAC68: .word ov05_021F64FC
_021DAC6C: .word 0x00000615

	thumb_func_start ov05_021DAC70
ov05_021DAC70: ; 0x021DAC70
	push {r3, r4, r5, r6, r7, lr}
	sub sp, #0x40
	add r4, r1, #0
	add r5, r0, #0
...
_021DAC98:
	ldr r3, _021DAE0C ; =ov05_021F64EC
	add r2, sp, #0x20
	ldmia r3!, {r0, r1}
	stmia r2!, {r0, r1}
	ldmia r3!, {r0, r1}
...
_021DAE04:
	...
	pop {r3, r4, r5, r6, r7, pc}
	nop
_021DAE0C: .word ov05_021F64EC
_021DAE10: .word 0x00000615

	thumb_func_start ov05_021DAE14
ov05_021DAE14: ; 0x021DAE14
	push {r3, r4, r5, lr}
	add r4, r0, #0
...
_021DAE3C:
	...
	thumb_func_start ov05_021DAE40
ov05_021DAE40: ; 0x021DAE40
	push {r4, r5, r6, r7, lr}
	sub sp, #0x84
	ldr r6, _021DAED0 ; =ov05_021F65AC
	str r3, [sp, #0x18]
	add r5, r0, #0
	add r7, r1, #0
	add r4, sp, #0x34
...
_021DAEC8:
	...
	pop {r4, r5, r6, r7, pc}
	.balign 4, 0
_021DAED0: .word ov05_021F65AC

	thumb_func_start ov05_021DAED4
ov05_021DAED4: ; 0x021DAED4
	push {r3, r4, r5, r6, r7, lr}
	add r5, r0, #0
	ldr r0, [r5, #0x50]
	add r7, r1, #0
...
_021DAF24: .word 0x00000605
	...
	thumb_func_start ov05_021DAF28
ov05_021DAF28: ; 0x021DAF28
	push {r3, r4, r5, r6, r7, lr}
	add r5, r0, #0
	ldr r0, [r5, #0x50]
	add r7, r1, #0
...
_021DAF74: .word 0x00000607
	...
	thumb_func_start ov05_021DAF78
ov05_021DAF78: ; 0x021DAF78
	push {r3, r4, r5, lr}
	add r5, r0, #0
	add r4, r1, #0
	mov r0, #4
	...
	strb r4, [r2]
	ldr r0, [r5, #0x10]
	ldr r1, _021DAF94 ; =ov05_021DAE14
	bl TaskManager_Call
	pop {r3, r4, r5, pc}
	.balign 4, 0
_021DAF94: .word ov05_021DAE14

	thumb_func_start ov05_021DAF98
ov05_021DAF98: ; 0x021DAF98
	add r3, r0, #0
	add r2, r1, #0
	ldr r0, [r3, #0x4c]
	ldr r1, [r3, #0x50]
	ldr r3, _021DAFA4 ; =ov05_021DA54C
	bx r3
	.balign 4, 0
_021DAFA4: .word ov05_021DA54C

	thumb_func_start ov05_021DAFA8
ov05_021DAFA8: ; 0x021DAFA8
	push {r4, r5, lr}
	sub sp, #0x2c
	add r5, r2, #0
	ldr r2, _021DB02C ; =ov05_021F64E4
	add r4, r3, #0
	ldr r3, [r2]
	ldr r2, [r2, #4]
	str r3, [sp, #0xc]
...
_021DB008:
	...
	pop {r4, r5, pc}
	nop
_021DB02C: .word ov05_021F64E4

	thumb_func_start ov05_021DB030
ov05_021DB030: ; 0x021DB030
	push {r3, lr}
	mov r0, #4
	mov r1, #0x10
	bl Heap_AllocAtEnd
	...
	thumb_func_start ov05_021DB040
ov05_021DB040: ; 0x021DB040
	push {r3, r4, r5, r6, lr}
	sub sp, #0xc
	add r4, r0, #0
	bl TaskManager_GetFieldSystem
...
_021DB140: .word 0x00007FFF
	...
	thumb_func_start ov05_021DB144
ov05_021DB144: ; 0x021DB144
	push {r4, r5, lr}
	sub sp, #0xc
	add r5, r0, #0
	bl TaskManager_GetFieldSystem
...
_021DB1CC: .word 0x00007FFF
	...
	thumb_func_start ov05_021DB1D0
ov05_021DB1D0: ; 0x021DB1D0
	push {r4, r5, r6, lr}
	sub sp, #0x10
	add r5, r0, #0
	bl TaskManager_GetFieldSystem
...
_021DB24C: .word 0x00000603
	...
	thumb_func_start ov05_021DB250
ov05_021DB250: ; 0x021DB250
	push {r3, r4, r5, r6, r7, lr}
	sub sp, #0x18
	str r0, [sp, #0x10]
	bl TaskManager_GetFieldSystem
...
_021DB37C: .word 0x0000FFA0
	...
	thumb_func_start ov05_021DB380
ov05_021DB380: ; 0x021DB380
	push {r3, r4, r5, r6, r7, lr}
	sub sp, #0x10
	add r7, r0, #0
	bl TaskManager_GetFieldSystem
...
_021DB446:
	...
	.global ov05_021F64E4
ov05_021F64E4: ; 0x021F64E4
	.word 0x0000012F, 0x00000130

	.global ov05_021F64EC
ov05_021F64EC: ; 0x021F64EC
	.word 0x00000082, 0x00000083, 0x000001A9, 0x000001AA

	.global ov05_021F64FC
ov05_021F64FC: ; 0x021F64FC
	.word 0x00000082, 0x00000083, 0x000001A9, 0x000001AA

	.global ov05_021F650C
ov05_021F650C: ; 0x021F650C
	...
	.global ov05_021F655C
ov05_021F655C: ; 0x021F655C
	.word 0x00000042, 0x00000043, 0x00000044, 0x00000045
	.word 0x000000F6, 0x00000046, 0x000001AB, 0x000001C8
	.word 0x00000104, 0x00000138, 0x00000139, 0x000001B6
	.word 0x000001BC, 0x000001B9, 0x000001BA, 0x0000012A
	...
	.global ov05_021F65AC
ov05_021F65AC: ; 0x021F65AC
	.word 0x00000042, 0x00000043, 0x00000044, 0x00000045
	.word 0x000000F6, 0x00000046, 0x000001AB, 0x000001C8
	.word 0x00000104, 0x00000138, 0x00000139, 0x000001B6
	.word 0x000001BC, 0x000001B9, 0x000001BA, 0x0000012A
