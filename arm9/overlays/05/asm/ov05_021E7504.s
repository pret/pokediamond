	...
	thumb_func_start ov05_021E7504
ov05_021E7504: ; 0x021E7504
	add r1, r0, #0
	ldr r0, [r1, #0x10]
	cmp r0, #3
	bhi _021E7536
...
_021E7614: .word 0x40C19999
	...
	thumb_func_start ov05_021E7618
ov05_021E7618: ; 0x021E7618
...
_021E774C: .word 0x0000064F
	...
	thumb_func_start ov05_021E7750
ov05_021E7750: ; 0x021E7750
	push {r3, r4, r5, r6, r7, lr}
	add r5, r0, #0
	add r6, r1, #0
	mov r0, #4
