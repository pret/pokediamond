	...
	thumb_func_start ov05_021F4968
ov05_021F4968: ; 0x021F4968
	ldr r2, [r1, #0x14]
...
_021F49A8: .word 0x000008B8
	...
	thumb_func_start ov05_021F49AC
ov05_021F49AC: ; 0x021F49AC
...
_021F4B46:
	...
	cmp r0, #0
	bne _021F4B6A
	ldr r0, _021F4BC4 ; =ov05_021FC624
	bl G3X_SetEdgeColorTable
	b _021F4B70
_021F4B6A:
	ldr r0, _021F4BC8 ; =ov05_021FC634
	bl G3X_SetEdgeColorTable
_021F4B70:
	bl ov05_021DB900
	ldr r1, _021F4BB4 ; =0x000008AC
	str r0, [r5, r1]
	ldr r1, _021F4BCC ; =ov05_021FD648
	add r0, sp, #0x10
	bl sprintf
	ldr r1, _021F4BB4 ; =0x000008AC
	add r0, sp, #0x10
...
_021F4BC4: .word ov05_021FC624
_021F4BC8: .word ov05_021FC634
_021F4BCC: .word ov05_021FD648

	thumb_func_start ov05_021F4BD0
ov05_021F4BD0: ; 0x021F4BD0
	push {r3, r4, r5, lr}
	add r5, r0, #0
	add r4, r1, #0
	bne _021F4BDC
...
_021F4BF4:
	...
	thumb_func_start ov05_021F4BF8
ov05_021F4BF8: ; 0x021F4BF8
	push {r3, r4, r5, r6, r7, lr}
	add r5, r0, #0
	ldr r1, [r5]
...
_021F4C70: .word 0x0000089C
	...
	thumb_func_start ov05_021F4C74
ov05_021F4C74: ; 0x021F4C74
	push {r4, lr}
	add r4, r0, #0
	bne _021F4C7E
	bl GF_AssertFail
...
_021F4C84: .word 0x000008A4
	...
	thumb_func_start ov05_021F4C88
ov05_021F4C88: ; 0x021F4C88
	push {r4, lr}
	add r4, r0, #0
	bne _021F4C92
	bl GF_AssertFail
...
_021F4C98: .word 0x000008A8
	...
	thumb_func_start ov05_021F4C9C
ov05_021F4C9C: ; 0x021F4C9C
...
_021F4CA4: .word 0x000008AC
	...
	thumb_func_start ov05_021F4CA8
ov05_021F4CA8: ; 0x021F4CA8
...
_021F4CB8: .word 0x000008B6
	...
	thumb_func_start ov05_021F4CBC
ov05_021F4CBC: ; 0x021F4CBC
...
_021F4CD0: .word 0x000008B6
	...
	thumb_func_start ov05_021F4CD4
ov05_021F4CD4: ; 0x021F4CD4
...
_021F4CE0: .word 0x000008BC
	...
	thumb_func_start ov05_021F4CE4
ov05_021F4CE4: ; 0x021F4CE4
	lsl r1, r1, #2
	add r0, r0, r1
	ldr r0, [r0, #4]
	cmp r0, #0
...
_021F4CF2:
	...
	.global ov05_021FC624
ov05_021FC624: ; 0x021FC624
	.byte 0x00, 0x00, 0x84, 0x10, 0x84, 0x10, 0x84, 0x10
	.byte 0x84, 0x10, 0x84, 0x10, 0x84, 0x10, 0x84, 0x10

	.global ov05_021FC634
ov05_021FC634: ; 0x021FC634
	.byte 0x84, 0x10, 0x84, 0x10, 0x84, 0x10, 0x84, 0x10
	.byte 0x84, 0x10, 0x84, 0x10, 0x84, 0x10, 0x84, 0x10
	...
	.balign 4
	.global ov05_021FD648
ov05_021FD648: ; 0x021FD648
