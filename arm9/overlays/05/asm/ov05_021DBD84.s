	...
	thumb_func_start ov05_021DBD84
ov05_021DBD84: ; 0x021DBD84
	push {r4, r5, r6, r7, lr}
	sub sp, #0xc
	add r7, r0, #0
	add r5, r1, #0
	mov r0, #0x18
	ldr r1, _021DBDE8 ; =ov05_021F6608
	mul r0, r2
	add r6, r3, #0
	add r4, r1, r0
	cmp r2, #0x10
...
_021DBDE2:
	...
	pop {r4, r5, r6, r7, pc}
	nop
_021DBDE8: .word ov05_021F6608

	thumb_func_start ov05_021DBDEC
ov05_021DBDEC: ; 0x021DBDEC
	...
	.global ov05_021F6608
ov05_021F6608: ; 0x021F6608
