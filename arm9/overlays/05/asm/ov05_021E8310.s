	...
	thumb_func_start ov05_021E8310
ov05_021E8310: ; 0x021E8310
...
_021E8346:
	...
	thumb_func_start ov05_021E835C
ov05_021E835C: ; 0x021E835C
	push {r3, r4, r5, lr}
	sub sp, #8
	add r4, r1, #0
	ldr r2, [r4, #4]
...
_021E83D6:
	...
	thumb_func_start ov05_021E8400
ov05_021E8400: ; 0x021E8400
	ldr r0, [r0]
	cmp r0, #0
	beq _021E840A
	mov r0, #0xa
...
_021E840A:
	...
	thumb_func_start ov05_021E8410
ov05_021E8410: ; 0x021E8410
	push {r3, r4, r5, r6, r7, lr}
	sub sp, #0x18
	add r5, r0, #0
	mov r0, #0
	...
	ldr r7, _021E84F0 ; =ov05_021F78C4
	str r0, [sp, #0xc]
_021E8460:
	ldr r0, [sp, #0xc]
	ldr r1, [r0]
...
_021E8642:
	...
	.global ov05_021F78C4
ov05_021F78C4: ; 0x021F78C4
	.word 0x00000006, 0x00000007, 0x00000008, 0x00000000

	.global ov05_021F78D4
ov05_021F78D4: ; 0x021F78D4
