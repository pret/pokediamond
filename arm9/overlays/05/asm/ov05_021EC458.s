...
_021EC48C:
	...
	thumb_func_start ov05_021EC49C
ov05_021EC49C: ; 0x021EC49C
	push {r3, r4, r5, r6, r7, lr}
	add r5, r0, #0
	ldr r0, _021EC4D8 ; =ov05_021FD680
	mov r4, #0
	str r5, [r0]
	mov r6, #5
	add r7, r4, #0
...
_021EC4C6:
	...
	pop {r3, r4, r5, r6, r7, pc}
	nop
_021EC4D8: .word ov05_021FD680

	thumb_func_start ov05_021EC4DC
ov05_021EC4DC: ; 0x021EC4DC
	push {r3, lr}
	mov r1, #6
	mov r2, #0
	bl BoxPokemon_GetData
	...
	thumb_func_start ov05_021EC4F0
ov05_021EC4F0: ; 0x021EC4F0
	push {r4, r5, r6, r7, lr}
	sub sp, #0x24
	add r5, r2, #0
	add r6, r0, #0
...
_021EC578: .word 0x000001B9
	...
	thumb_func_start ov05_021EC57C
ov05_021EC57C: ; 0x021EC57C
	push {r3, r4, r5, r6, r7, lr}
	add r7, r3, #0
	add r5, r0, #0
	add r0, r7, #0
	...
	thumb_func_start ov05_021EC5B0
ov05_021EC5B0: ; 0x021EC5B0
	push {r3, r4, r5, r6, r7, lr}
	add r4, r0, #0
	mov r1, #0
	bl Save_Daycare_GetMonX
...
_021EC600:
	...
	thumb_func_start ov05_021EC604
ov05_021EC604: ; 0x021EC604
	push {r4, r5, r6, r7, lr}
	sub sp, #0xc
	add r5, r0, #0
	mov r0, #0
...
_021EC664: .word 0x0000FFFF
	...
	thumb_func_start ov05_021EC668
ov05_021EC668: ; 0x021EC668
	push {r4, r5, r6, r7, lr}
	sub sp, #0xc
	str r0, [sp]
	add r6, r1, #0
...
_021EC6FA:
	...
	thumb_func_start ov05_021EC71C
ov05_021EC71C: ; 0x021EC71C
	push {r4, r5, r6, lr}
	add r6, r2, #0
	add r5, r0, #0
	add r4, r1, #0
	...
	thumb_func_start ov05_021EC744
ov05_021EC744: ; 0x021EC744
	push {r3, r4, r5, r6, r7, lr}
	add r6, r0, #0
	mov r0, #4
	add r5, r1, #0
	...
	thumb_func_start ov05_021EC78C
ov05_021EC78C: ; 0x021EC78C
	...
	thumb_func_start ov05_021EC7B4
ov05_021EC7B4: ; 0x021EC7B4
	...
	thumb_func_start ov05_021EC7D4
ov05_021EC7D4: ; 0x021EC7D4
	push {r4, r5, r6, lr}
	sub sp, #8
	add r4, r0, #0
	add r5, r1, #0
	...
	thumb_func_start ov05_021EC810
ov05_021EC810: ; 0x021EC810
	push {r4, r5, r6, lr}
	sub sp, #8
	add r4, r0, #0
	add r5, r1, #0
	...
	thumb_func_start ov05_021EC854
ov05_021EC854: ; 0x021EC854
	...
	thumb_func_start ov05_021EC864
...
_021EC888:
	...
	thumb_func_start ov05_021EC88C
ov05_021EC88C: ; 0x021EC88C
	push {r3, r4, r5, lr}
	add r4, r1, #0
	add r5, r0, #0
	mov r1, #0
	...
	thumb_func_start ov05_021EC8A8
ov05_021EC8A8: ; 0x021EC8A8
	push {r4, r5, r6, r7, lr}
	sub sp, #0x14
	mov r1, #0
	mvn r1, r1
...
_021EC940: .word 0x00007FFF
	...
	thumb_func_start ov05_021EC944
ov05_021EC944: ; 0x021EC944
	push {r3, r4, r5, r6, r7, lr}
	str r0, [sp]
	mov r5, #0
	bl ov05_021EC8A8
...
_021EC990:
	...
	thumb_func_start ov05_021EC99C
ov05_021EC99C: ; 0x021EC99C
	push {r3, r4}
	sub sp, #8
	mov r2, #0xff
	strb r2, [r0, r1]
...
_021EC9C4:
	...
	thumb_func_start ov05_021EC9D4
ov05_021EC9D4: ; 0x021EC9D4
	push {r4, r5, r6, r7, lr}
	sub sp, #0x14
	add r4, r0, #0
	str r1, [sp]
...
_021ECAEE:
	...
	thumb_func_start ov05_021ECAFC
ov05_021ECAFC: ; 0x021ECAFC
	push {r3, r4, r5, r6, r7, lr}
	mov r4, #0
	add r5, r1, #0
	mov r1, #5
	...
	add r2, r2, r0
	ldr r0, _021ECB68 ; =ov05_021F7B48
	add r1, r4, #0
_021ECB1A:
	lsl r7, r1, #1
	ldrh r7, [r0, r7]
...
_021ECB2A:
	...
	blo _021ECB1A
_021ECB34:
	ldr r2, _021ECB68 ; =ov05_021F7B48
	lsl r0, r6, #1
...
_021ECB68: .word ov05_021F7B48

	thumb_func_start ov05_021ECB6C
ov05_021ECB6C: ; 0x021ECB6C
	push {r3, r4, r5, r6, r7, lr}
	sub sp, #0x28
	add r7, r0, #0
	str r1, [sp]
...
_021ECD60: .word 0x0000FFFF
	...
	thumb_func_start ov05_021ECD64
ov05_021ECD64: ; 0x021ECD64
	push {r4, lr}
	add r4, r0, #0
	mov r1, #0
	bl Save_Daycare_SetEggPID
...
ov05_021ECD78: ; 0x021ECD78
	...
	add r1, sp, #0
	bl ov05_021EC88C
	ldr r2, _021ECDE8 ; =ov05_021F7B12
	mov r3, #0
	mov r1, #6
_021ECD8C:
	add r0, r3, #0
...
_021ECDAE:
	...
	add r1, r6, #0
	mul r1, r0
	ldr r0, _021ECDEC ; =ov05_021F7B14
	ldrh r0, [r0, r1]
	cmp r4, r0
	beq _021ECDE0
	cmp r2, r0
	beq _021ECDE0
	ldr r0, _021ECDF0 ; =ov05_021F7B16
	ldrh r5, [r0, r1]
_021ECDE0:
	add r0, r5, #0
	add sp, #8
	pop {r4, r5, r6, pc}
	nop
_021ECDE8: .word ov05_021F7B12
_021ECDEC: .word ov05_021F7B14
_021ECDF0: .word ov05_021F7B16

	thumb_func_start ov05_021ECDF4
ov05_021ECDF4: ; 0x021ECDF4
	push {r3, r4, r5, lr}
	sub sp, #8
	add r4, r0, #0
	add r0, r1, #0
...
_021ECE40: .word 0x0000FFFF
	...
	thumb_func_start ov05_021ECE44
ov05_021ECE44: ; 0x021ECE44
	push {r3, r4, r5, r6, r7, lr}
	sub sp, #0x10
	add r5, r1, #0
	add r1, sp, #4
...
_021ECF10: .word 0x000001EA
	...
	thumb_func_start ov05_SetEggStats
ov05_SetEggStats: ; 0x021ECF14
	push {r0, r1, r2, r3}
	push {r4, r5, r6, lr}
	sub sp, #0x20
	add r6, r1, #0
	add r5, r0, #0
	add r0, r6, #0
	mov r1, #0x13 ; SPECIES_DATA_EGG_CYCLES
	add r4, r3, #0
	bl Species_GetValue
	add r1, sp, #0x10
	strb r0, [r1]
...
_021ED168:
	...
	thumb_func_start ov05_021ED190
...
_021ED1E0:
	...
	thumb_func_start ov05_021ED1E4
ov05_021ED1E4: ; 0x021ED1E4
	push {r4, r5, r6, r7}
	mov r4, #0
	add r3, r4, #0
_021ED1EA:
...
_021ED1FC:
	...
	thumb_func_start ov05_021ED214
ov05_021ED214: ; 0x021ED214
	push {r4, r5, r6, r7, lr}
	sub sp, #0x24
	add r5, r0, #0
	mov r0, #0
...
_021ED228:
	...
	stmia r7!, {r0}
	ldrh r0, [r4]
	mov r1, #0x16 ; SPECIES_DATA_EGG_GROUP_1
	bl Species_GetValue
	strh r0, [r6]
	ldrh r0, [r4]
	mov r1, #0x17 ; SPECIES_DATA_EGG_GROUP_2
	bl Species_GetValue
	strh r0, [r6, #2]
	ldr r0, [sp]
	add r5, r5, #4
...
_021ED318:
	...
	thumb_func_start ov05_021ED320
ov05_021ED320: ; 0x021ED320
	push {r3, lr}
	sub sp, #8
	add r1, sp, #0
	bl ov05_021EC88C
	...
	thumb_func_start ov05_021ED334
ov05_021ED334: ; 0x021ED334
	push {r3, r4, r5, lr}
	add r4, r0, #0
	bl Script_GetDay
	add r5, r0, #0
	...
	pop {r3, r4, r5, pc}
_021ED358:
	ldr r2, _021ED374 ; =ov05_021F7AF8
	mov r1, #0
_021ED35C:
	ldrh r0, [r2]
	cmp r5, r0
...
_021ED366:
	...
	pop {r3, r4, r5, pc}
	nop
_021ED374: .word ov05_021F7AF8

	thumb_func_start ov05_021ED378
ov05_021ED378: ; 0x021ED378
	push {r4, r5, r6, r7, lr}
	sub sp, #0x14
	add r7, r1, #0
	add r1, sp, #8
...
_021ED498: .word 0x0000FFFF
	...
	thumb_func_start ov05_021ED49C
...
_021ED4DA:
	...
	thumb_func_start ov05_021ED4E0
ov05_021ED4E0: ; 0x021ED4E0
	push {r4, lr}
	sub sp, #8
	add r4, r1, #0
	add r1, sp, #0
...
_021ED526:
	...
	thumb_func_start ov05_021ED52C
ov05_021ED52C: ; 0x021ED52C
	push {r3, r4, r5, r6, r7, lr}
	sub sp, #0x10
	add r4, r1, #0
	add r1, sp, #0x18
...
_021ED5B4:
	...
	thumb_func_start ov05_021ED5C4
ov05_021ED5C4: ; 0x021ED5C4
	...
	thumb_func_start ov05_021ED5EC
...
_021ED60E:
	...
	thumb_func_start ov05_021ED614
ov05_021ED614: ; 0x021ED614
	cmp r0, #0x14
	bhi _021ED620
	bhs _021ED632
	cmp r0, #0
...
_021ED63E:
	...
	thumb_func_start ov05_021ED644
ov05_021ED644: ; 0x021ED644
	push {r3, lr}
	bl ov05_021ED320
	bl ov05_021ED614
	pop {r3, pc}

	thumb_func_start ov05_021ED650
ov05_021ED650: ; 0x021ED650
	push {r4, r5, r6, r7, lr}
	sub sp, #0x3c
	add r4, r0, #0
	add r5, r1, #0
...
_021ED93C: .word 0x000001EA
	...
	thumb_func_start ov05_021ED940
ov05_021ED940: ; 0x021ED940
	push {r4, r5, lr}
	sub sp, #0x1c
	mov r3, #0x46
	add r2, sp, #0
	...
	thumb_func_start ov05_021ED9B4
ov05_021ED9B4: ; 0x021ED9B4
	push {r3, lr}
	bl ov05_021ED214
	bl ov05_021ED614
	pop {r3, pc}
	...
	.global ov05_021F7AF8
ov05_021F7AF8: ; 0x021F7AF8
	...
	.global ov05_021F7B12
ov05_021F7B12: ; 0x021F7B12
	.byte 0x68, 0x01

	.global ov05_021F7B14
ov05_021F7B14: ; 0x021F7B14
	.byte 0xFF, 0x00

	.global ov05_021F7B16
ov05_021F7B16: ; 0x021F7B16
	...
	.global ov05_021F7B48
ov05_021F7B48: ; 0x021F7B48
	...
	.global ov05_021FD680
ov05_021FD680: ; 0x021FD680
	.space 0x4
