	...
	thumb_func_start ov24_02254854
ov24_02254854: ; 0x02254854
	...
	cmp r0, #0
	beq _0225488E
	ldr r0, _02254898 ; =ov24_02254918
	add r1, r4, #0
	mov r2, #1
...
_02254894:
	...
	pop {r3, r4, r5, r6, r7, pc}
	.align 2, 0
_02254898: .word ov24_02254918
	thumb_func_end ov24_02254854

	thumb_func_start ov24_0225489C
ov24_0225489C: ; 0x0225489C
	push {r3, r4, r5, lr}
	add r5, r0, #0
	...
	ldr r2, _022548EC ; =ov24_02254960
	mov r1, #2
	add r3, r5, #0
	bl ov20_02254130
...
_022548E8: .word ov24_022550F8
_022548EC: .word ov24_02254960
_022548F0: .word 0x000016FC
	thumb_func_end ov24_0225489C

	thumb_func_start ov24_022548F4
ov24_022548F4: ; 0x022548F4
	push {r4, lr}
	add r4, r0, #0
...
_02254914: .word 0x000016F4
	thumb_func_end ov24_022548F4

	thumb_func_start ov24_02254918
ov24_02254918: ; 0x02254918
	push {r3, r4, r5, lr}
	add r4, r1, #0
	add r5, r0, #0
	ldrb r0, [r4]
	...
	add r0, r4, #0
	lsl r2, r1, #2
	ldr r1, _0225495C ; =ov24_02255100
	ldr r1, [r1, r2]
	blx r1
	cmp r0, #0
	beq _02254954
...
_0225495C: .word ov24_02255100
	thumb_func_end ov24_02254918

	thumb_func_start ov24_02254960
ov24_02254960: ; 0x02254960
	push {r3, lr}
	cmp r2, #1
	bne _02254988
	ldr r1, [r3, #8]
...
_0225498C: .word 0x000016F4
	thumb_func_end ov24_02254960

	thumb_func_start ov24_02254990
ov24_02254990: ; 0x02254990
	mov r1, #1
	strb r1, [r0, #2]
	bx lr
	.align 2, 0
	thumb_func_end ov24_02254990

	thumb_func_start ov24_02254998
ov24_02254998: ; 0x02254998
	ldrb r2, [r0, #2]
	cmp r2, #0
	bne _022549A0
	b _022549A2
...
_022549A2:
	...
	bx lr
	.align 2, 0
	thumb_func_end ov24_02254998

	thumb_func_start ov24_022549AC
ov24_022549AC: ; 0x022549AC
	push {r4, lr}
	add r4, r0, #0
	ldrb r0, [r4, #1]
	cmp r0, #0
...
_022549F4: .word 0x000016F8
	thumb_func_end ov24_022549AC

	thumb_func_start ov24_022549F8
...
_02254A6C: .word 0x000016F4
	thumb_func_end ov24_022549F8

	thumb_func_start ov24_02254A70
ov24_02254A70: ; 0x02254A70
	push {r4, lr}
	sub sp, #8
	add r4, r0, #0
	add r0, sp, #4
...
_02254ACC:
	...
	pop {r4, pc}
	.align 2, 0
	thumb_func_end ov24_02254A70

	thumb_func_start ov24_02254AD4
ov24_02254AD4: ; 0x02254AD4
	push {r4, lr}
	sub sp, #8
	add r4, r0, #0
	add r0, sp, #4
...
_02254B1A:
	...
	add sp, #8
	pop {r4, pc}
	thumb_func_end ov24_02254AD4

	thumb_func_start ov24_02254B20
ov24_02254B20: ; 0x02254B20
	push {r4, r5, r6, r7, lr}
	sub sp, #0x14
	add r5, r0, #0
	ldr r0, [sp, #0x28]
...
_02254C60: .word 0x000016F4
	thumb_func_end ov24_02254B20

	thumb_func_start ov24_02254C64
ov24_02254C64: ; 0x02254C64
	push {r4, lr}
	add r4, r0, #0
	ldrb r0, [r4, #1]
	cmp r0, #0
...
_02254C9C: .word 0x000016F4
	thumb_func_end ov24_02254C64

	thumb_func_start ov24_02254CA0
ov24_02254CA0: ; 0x02254CA0
	push {r4, r5, r6, lr}
	add r5, r0, #0
	add r6, r1, #0
	mov r0, #8
...
_02254CFA:
	...
	pop {r4, r5, r6, pc}
	.align 2, 0
	thumb_func_end ov24_02254CA0

	thumb_func_start ov24_02254D00
ov24_02254D00: ; 0x02254D00
	push {r4, lr}
	add r4, r0, #0
	mov r0, #8
	mov r1, #1
	...
	beq _02254D3C
	ldr r0, [r4, #4]
	ldr r2, _02254D40 ; =ov24_0225510C
	bl AddWindow
	mov r2, #0xbe
	ldr r1, [r4]
...
_02254D3C:
	...
	pop {r4, pc}
	.align 2, 0
_02254D40: .word ov24_0225510C
_02254D44: .word 0x000016E8
	thumb_func_end ov24_02254D00

	thumb_func_start ov24_02254D48
ov24_02254D48: ; 0x02254D48
	push {r4, lr}
	add r4, r0, #0
	beq _02254D84
	mov r0, #7
...
_02254D88: .word 0x000016E8
	...
	thumb_func_start ov24_02254D8C
ov24_02254D8C: ; 0x02254D8C
	push {lr}
	sub sp, #0xc
	add r2, r0, #0
	add r0, #8
	...
	mov r0, #8
	str r0, [sp, #8]
	ldr r0, _02254DAC ; =ov24_0225516C
	ldr r3, [r2]
	bl ov20_022537E0
	add sp, #0xc
	pop {pc}
	nop
_02254DAC: .word ov24_0225516C
	thumb_func_end ov24_02254D8C

	thumb_func_start ov24_02254DB0
ov24_02254DB0: ; 0x02254DB0
	ldr r3, _02254DB8 ; =ov20_02253794
	add r0, #8
	bx r3
	nop
_02254DB8: .word ov20_02253794
	thumb_func_end ov24_02254DB0

	thumb_func_start ov24_02254DBC
ov24_02254DBC: ; 0x02254DBC
	ldr r3, _02254DC4 ; =ov20_022537B8
	add r0, #8
	bx r3
	nop
_02254DC4: .word ov20_022537B8
	thumb_func_end ov24_02254DBC

	thumb_func_start ov24_02254DC8
ov24_02254DC8: ; 0x02254DC8
	push {r4, lr}
	add r4, r0, #0
	bl ov20_022538A0
	add r0, #8
	...
	pop {r4, pc}
	.align 2, 0
	thumb_func_end ov24_02254DC8

	thumb_func_start ov24_02254DDC
ov24_02254DDC: ; 0x02254DDC
	push {r4, r5, lr}
	sub sp, #0x14
	mov r0, #8
	add r4, r1, #0
...
_02254DF0:
	...
	add r5, r0, #0
	ldr r0, [r5, #4]
	ldr r2, _02254ED0 ; =ov24_02255114
	mov r1, #6
	mov r3, #0
	bl InitBgFromTemplate
	ldr r0, [r5, #4]
	ldr r2, _02254ED4 ; =ov24_02255130
	mov r1, #7
	mov r3, #0
	bl InitBgFromTemplate
	mov r0, #8
...
_02254ECC:
	...
	pop {r4, r5, pc}
	.align 2, 0
_02254ED0: .word ov24_02255114
_02254ED4: .word ov24_02255130
_02254ED8: .word 0x04001000
_02254EDC: .word 0xFFFFE0FF
	thumb_func_end ov24_02254DDC

	thumb_func_start ov24_02254EE0
ov24_02254EE0: ; 0x02254EE0
	push {r3, r4, r5, lr}
	add r5, r1, #0
	add r0, r5, #0
	bl ov20_022538A0
...
_02254F24: .word 0x00000663
	thumb_func_end ov24_02254EE0

	thumb_func_start ov24_02254F28
ov24_02254F28: ; 0x02254F28
	push {r4, lr}
	add r4, r1, #0
	add r0, r4, #0
	bl ov20_022538A0
