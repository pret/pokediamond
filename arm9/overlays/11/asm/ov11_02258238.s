	...
	thumb_func_start ov11_02258238
ov11_02258238: ; 0x02258238
	push {r4, r5, r6, r7, lr}
	sub sp, #0x24
	add r5, r0, #0
	ldr r0, [r5, #4]
	...
	bne _02258274
	lsl r1, r0, #1
	ldr r0, _02258320 ; =ov11_0225F5C0
	ldrh r3, [r0, r1]
...
_02258274:
	lsl r1, r0, #1
	ldr r0, _02258328 ; =ov11_0225F5A8
	ldrh r3, [r0, r1]
...
_02258288:
	...
	add r3, r1, #0
	mul r3, r2
	ldr r2, _02258330 ; =ov11_0225F5D8
	lsl r1, r6, #1
	add r2, r2, r3
	ldrh r1, [r1, r2]
	ldr r2, [sp, #0x20]
	...
	pop {r4, r5, r6, r7, pc}
	nop
_02258320: .word ov11_0225F5C0
_02258324: .word 0x00004E2D
_02258328: .word ov11_0225F5A8
_0225832C: .word 0x00004E2E
_02258330: .word ov11_0225F5D8
_02258334: .word 0x00004E29

	thumb_func_start ov11_02258338
ov11_02258338: ; 0x02258338
	push {r3, r4, r5, lr}
	add r4, r0, #0
	ldr r0, [r4, #4]
	bl ov11_02230078
	...
	ldrb r3, [r4, #8]
	mov r2, #0x34
	ldr r5, _02258368 ; =ov11_0225F61C
	mul r2, r3
	add r2, r5, r2
	bl sub_0200C154
	str r0, [r4]
	...
	pop {r3, r4, r5, pc}
	nop
_02258368: .word ov11_0225F61C

	thumb_func_start ov11_0225836C
ov11_0225836C: ; 0x0225836C
	push {r4, lr}
	add r4, r0, #0
	ldr r0, [r4]
	cmp r0, #0
...
_0225837E:
	...
	thumb_func_start ov11_02258380
ov11_02258380: ; 0x02258380
	push {r3, r4, r5, lr}
	add r5, r0, #0
	ldr r0, [r5, #4]
	bl ov11_02230080
...
_022583C4: .word 0x00004E29
	...
	thumb_func_start ov11_022583C8
ov11_022583C8: ; 0x022583C8
	push {r3, lr}
	ldr r0, [r0]
	cmp r0, #0
	beq _022583D4
...
_022583D4:
	...
	thumb_func_start ov11_022583D8
ov11_022583D8: ; 0x022583D8
...
_022583FE:
	...
	thumb_func_start ov11_0225840C
ov11_0225840C: ; 0x0225840C
	push {r4, lr}
	add r4, r0, #0
	bl ov11_0225836C
	add r0, r4, #0
	...
	.global ov11_0225F5A8
ov11_0225F5A8: ; 0x0225F5A8
	...
	.global ov11_0225F5C0
ov11_0225F5C0: ; 0x0225F5C0
	...
	.global ov11_0225F5D8
ov11_0225F5D8: ; 0x0225F5D8
	...
	.global ov11_0225F61C
ov11_0225F61C: ; 0x0225F61C
