...
_022339C6:
	...
	lsl r0, r0, #6
	ldrh r0, [r1, r0]
	mov r1, #9 ; SPECIES_DATA_EXP_YIELD
	bl Species_GetValue
	lsl r0, r0, #0x10
	lsr r1, r0, #0x10
	ldr r2, [r5, #0x74]
...
_02237900:
	...
	ldr r0, [sp, #4]
	add r1, r6, #0
	mov r2, #1 ; SPECIES_DATA_BASE_ATK
	...
	add r1, #0x26
	ldrb r1, [r2, r1]
	mov r2, #2 ; SPECIES_DATA_BASE_DEF
	lsl r1, r1, #0x1b
	lsr r1, r1, #0x1b
	bl Species_GetFormValue
	add r1, r0, #0
...
_0223A9D6:
	...
	str r0, [sp, #0x48]
	add r0, r6, #0
	bl Pokemon_GetCurrentLevelBaseExp
	ldr r1, [sp, #0x48]
	sub r0, r1, r0
	str r0, [r4, #0x3c]
	ldr r1, [sp, #0x48]
...
_0223BFEE:
	...
	lsl r0, r0, #6
	ldrh r0, [r1, r0]
	mov r1, #8 ; SPECIES_DATA_CATCH_RATE
	bl Species_GetValue
