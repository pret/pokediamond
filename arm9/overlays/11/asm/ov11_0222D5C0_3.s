	...
	thumb_func_start ov11_0222F29C
ov11_0222F29C: ; 0x0222F29C
	push {r4, r5, r6, lr}
	sub sp, #0x68
	add r4, r1, #0
...
_0222F30E:
	...
	lsl r2, r2, #8
	bl MIi_CpuClear16
	ldr r6, _0222F4CC ; =ov11_0225D9B8
	add r3, sp, #0x30
	add r2, r3, #0
	ldmia r6!, {r0, r1}
	stmia r3!, {r0, r1}
	...
	ldr r6, _0222F4D0 ; =ov11_0225DA04
	add r3, sp, #0x14
	ldmia r6!, {r0, r1}
	add r2, r3, #0
	stmia r3!, {r0, r1}
...
_0222F4C8: .word ov11_0225DA40
_0222F4CC: .word ov11_0225D9B8
_0222F4D0: .word ov11_0225DA04
_0222F4D4: .word 0x0000039B
_0222F4D8: .word ov11_0222F0D4
_0222F4DC: .word 0x0000FFFF
_0222F4E0: .word 0x00001024

	thumb_func_start ov11_0222F4E4
ov11_0222F4E4: ; 0x0222F4E4
	push {r4, r5, r6, r7, lr}
	sub sp, #0xc
...
_0222F938: .word 0x00001024
	...
	thumb_func_start ov11_0222F93C
ov11_0222F93C: ; 0x0222F93C
	push {r4, lr}
	bl OverlayManager_GetData
	add r4, r0, #0
	mov r0, #0
	...
	thumb_func_start ov11_0222F988
ov11_0222F988: ; 0x0222F988
	push {r4, r5, r6, lr}
...
_0222F9C6:
	...
	pop {r4, r5, r6, pc}
_0222F9CA:
	ldr r0, _0222FAB8 ; =SDK_OVERLAY_OVERLAY_07_ID
	mov r1, #2
...
_0222FAB8: .word SDK_OVERLAY_OVERLAY_07_ID

	thumb_func_start ov11_0222FABC
ov11_0222FABC: ; 0x0222FABC
...
_0222FAFE:
	...
	thumb_func_start ov11_0222FB04
ov11_0222FB04: ; 0x0222FB04
	push {r3, r4, r5, r6, r7, lr}
	add r5, r0, #0
	bl OverlayManager_GetData
	add r4, r0, #0
...
_0222FC2A:
	...
	thumb_func_start ov11_0222FC38
ov11_0222FC38: ; 0x0222FC38
	push {r3, r4, r5, r6, r7, lr}
	bl OverlayManager_GetData
	add r6, r0, #0
	mov r0, #7
...
_0222FC7A:
	...
	thumb_func_start ov11_0222FC80
ov11_0222FC80: ; 0x0222FC80
	push {r3, r4, r5, r6, r7, lr}
	sub sp, #0x10
	bl OverlayManager_GetField18
	add r7, r0, #0
...
_0222FCA2:
	...
	pop {r3, r4, r5, r6, r7, pc}
_0222FCA8:
	ldr r0, _0222FE54 ; =SDK_OVERLAY_OVERLAY_07_ID
	mov r1, #2
	bl HandleLoadOverlay
	mov r0, #5
	mov r1, #0x2c
...
_0222FE48:
	...
	pop {r3, r4, r5, r6, r7, pc}
	.align 2, 0
_0222FE54: .word SDK_OVERLAY_OVERLAY_07_ID

	thumb_func_start ov11_0222FE58
ov11_0222FE58: ; 0x0222FE58
	push {r4, r5, r6, lr}
	bl OverlayManager_GetField18
	mov r1, #0x66
	lsl r1, r1, #2
...
_0222FE8E:
	...
	thumb_func_start ov11_0222FE94
ov11_0222FE94: ; 0x0222FE94
	push {r3, lr}
	ldr r1, [r0, #0x2c]
...
_0222FEBC: .word 0x00000404
	...
	thumb_func_start ov11_0222FEC0
ov11_0222FEC0: ; 0x0222FEC0
	push {r3, r4, r5, r6, r7, lr}
	sub sp, #0x40
	str r0, [sp]
	mov r0, #0x5f
