...
UNK_02105E10: ; 0x02105E10
	...
	thumb_func_start ScrCmd_unk_327
ScrCmd_unk_327: ; 0x0203FCF4
	push {r4-r7, lr}
	sub sp, #0x84
	add r7, r0, #0x0
...
_0203FDB8: .word 0x0000FFFF
	...
	thumb_func_start ScrCmd_unk_328
ScrCmd_unk_328: ; 0x0203FDBC
	push {r3-r4, lr}
	sub sp, #0x4
	add r4, r0, #0x0
	bl ScriptReadHalfword
...
_0203FE04: .word UNK_02105E10
	...
	thumb_func_start ScrCmd_unk_329
ScrCmd_unk_329: ; 0x0203FE08
	push {r3-r4, lr}
	sub sp, #0x4
	add r4, r0, #0x0
	bl ScriptReadHalfword
...
_0203FE44: .word UNK_02105DEC
	...
	thumb_func_start ScrCmd_unk_330
ScrCmd_unk_330: ; 0x0203FE48
	push {r3-r4, lr}
	sub sp, #0x4
	add r4, r0, #0x0
	bl ScriptReadHalfword
...
_0203FE7C: .word UNK_02105DF4
	...
	thumb_func_start ScrCmd_unk_599
ScrCmd_unk_599: ; 0x0203FE80
	push {r3, lr}
	add r0, #0x80
	ldr r0, [r0, #0x0]
	ldr r0, [r0, #0x10]
