...
UNK_020F4340: ; 0x020F4340
	...
	thumb_func_start ScrCmd_BattleTowerWorkClear
ScrCmd_BattleTowerWorkClear: ; 0x02042354
	push {r3, lr}
	add r0, #0x80
	ldr r0, [r0, #0x0]
	add r0, #0xa8
	...
	thumb_func_start ScrCmd_BattleTowerWorkInit
ScrCmd_BattleTowerWorkInit: ; 0x02042364
	push {r4-r6, lr}
	add r5, r0, #0x0
	...
	thumb_func_start ScrCmd_BattleTowerWorkRelease
ScrCmd_BattleTowerWorkRelease: ; 0x02042394
	push {r4, lr}
	add r4, r0, #0x0
	add r0, #0x80
	ldr r0, [r0, #0x0]
	...
	thumb_func_start ScrCmd_BattleTowerTools
ScrCmd_BattleTowerTools: ; 0x020423B0
	push {r3-r7, lr}
	sub sp, #0x8
	add r7, r0, #0x0
	bl ScriptReadHalfword
...
_020426FA:
	...
	thumb_func_start ScrCmd_BattleTowerGetSevenPokeData
ScrCmd_BattleTowerGetSevenPokeData: ; 0x02042700
	push {r3-r7, lr}
	add r5, r0, #0x0
	add r1, r5, #0x0
	add r1, #0x80
	...
	thumb_func_start ScrCmd_BattleTowerIsPrizeGet
ScrCmd_BattleTowerIsPrizeGet: ; 0x02042780
	push {r3-r5, lr}
	add r5, r0, #0x0
	bl ScriptReadHalfword
	add r1, r0, #0x0
	...
	thumb_func_start ScrCmd_BattleTowerIsPrizemanSet
ScrCmd_BattleTowerIsPrizemanSet: ; 0x020427A8
	push {r3-r5, lr}
	add r5, r0, #0x0
	bl ScriptReadHalfword
	add r1, r0, #0x0
	...
	thumb_func_start ScrCmd_BattleTowerSendBuf
ScrCmd_BattleTowerSendBuf: ; 0x020427D0
	push {r3-r7, lr}
	add r5, r0, #0x0
	bl ScriptReadHalfword
	add r1, r0, #0x0
...
_02042860: .word 0x0000083E
	...
	thumb_func_start ScrCmd_BattleTowerRecvBuf
ScrCmd_BattleTowerRecvBuf: ; 0x02042864
	push {r3-r5, lr}
	add r5, r0, #0x0
	bl ScriptReadHalfword
	add r1, r0, #0x0
	...
	thumb_func_start ScrCmd_BattleTowerGetLeaderRoomID
ScrCmd_BattleTowerGetLeaderRoomID: ; 0x02042894
	push {r3-r6, lr}
	sub sp, #0x4
	add r5, r0, #0x0
	bl ScriptReadHalfword
	...
	thumb_func_start ScrCmd_BattleTowerIsLeaderDataExist
ScrCmd_BattleTowerIsLeaderDataExist: ; 0x020428E0
	push {r3-r5, lr}
	add r5, r0, #0x0
	bl ScriptReadHalfword
	add r1, r0, #0x0
...
_0204294C: .word UNK_020F4334
	...
	thumb_func_start ScrCmd_BtlPointWinWrite
ScrCmd_BtlPointWinWrite: ; 0x02042950
	push {r3-r7, lr}
	add r5, r0, #0x0
	add r0, #0x80
	ldr r1, [r5, #0x8]
	...
	thumb_func_start ScrCmd_BtlPointWinDel
ScrCmd_BtlPointWinDel: ; 0x02042980
	push {r3, lr}
	add r0, #0x80
	ldr r0, [r0, #0x0]
	mov r1, #0x26
	...
	thumb_func_start ScrCmd_BtlPointWrite
ScrCmd_BtlPointWrite: ; 0x02042998
	push {r4, lr}
	add r4, r0, #0x0
	add r0, #0x80
	ldr r0, [r0, #0x0]
	...
	thumb_func_start ScrCmd_CheckBtlPoint
ScrCmd_CheckBtlPoint: ; 0x020429B8
	push {r3-r5, lr}
	add r5, r0, #0x0
	add r1, r5, #0x0
	add r1, #0x80
	...
	thumb_func_start ScrCmd_AddBtlPoint
ScrCmd_AddBtlPoint: ; 0x020429E8
	push {r3-r5, lr}
	add r5, r0, #0x0
	add r1, r5, #0x0
	add r1, #0x80
	...
	thumb_func_start ScrCmd_SubBtlPoint
ScrCmd_SubBtlPoint: ; 0x02042A18
	push {r3-r5, lr}
	add r5, r0, #0x0
	add r1, r5, #0x0
	add r1, #0x80
	...
	thumb_func_start ScrCmd_CompBtlPoint
ScrCmd_CompBtlPoint: ; 0x02042A48
	push {r4-r6, lr}
	add r4, r0, #0x0
	add r1, r4, #0x0
	add r1, #0x80
...
_02042A90:
	...
	thumb_func_start ScrCmd_GetBtlPointGift
ScrCmd_GetBtlPointGift: ; 0x02042A98
	push {r3-r7, lr}
	add r5, r0, #0x0
	bl ScriptReadHalfword
	add r1, r0, #0x0
