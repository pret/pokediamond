...
UNK_020F4340: ; 0x020F4340
	...
	thumb_func_start ScrCmd_unk_474
ScrCmd_unk_474: ; 0x02042354
	push {r3, lr}
	add r0, #0x80
	ldr r0, [r0, #0x0]
	add r0, #0xa8
	...
	thumb_func_start ScrCmd_unk_475
ScrCmd_unk_475: ; 0x02042364
	push {r4-r6, lr}
	add r5, r0, #0x0
	...
	thumb_func_start ScrCmd_unk_476
ScrCmd_unk_476: ; 0x02042394
	push {r4, lr}
	add r4, r0, #0x0
	add r0, #0x80
	ldr r0, [r0, #0x0]
	...
	thumb_func_start ScrCmd_unk_477
ScrCmd_unk_477: ; 0x020423B0
	push {r3-r7, lr}
	sub sp, #0x8
	add r7, r0, #0x0
	bl ScriptReadHalfword
...
_020426FA:
	...
	thumb_func_start ScrCmd_unk_478
ScrCmd_unk_478: ; 0x02042700
	push {r3-r7, lr}
	add r5, r0, #0x0
	add r1, r5, #0x0
	add r1, #0x80
	...
	thumb_func_start ScrCmd_unk_479
ScrCmd_unk_479: ; 0x02042780
	push {r3-r5, lr}
	add r5, r0, #0x0
	bl ScriptReadHalfword
	add r1, r0, #0x0
	...
	thumb_func_start ScrCmd_unk_480
ScrCmd_unk_480: ; 0x020427A8
	push {r3-r5, lr}
	add r5, r0, #0x0
	bl ScriptReadHalfword
	add r1, r0, #0x0
	...
	thumb_func_start ScrCmd_unk_481
ScrCmd_unk_481: ; 0x020427D0
	push {r3-r7, lr}
	add r5, r0, #0x0
	bl ScriptReadHalfword
	add r1, r0, #0x0
...
_02042860: .word 0x0000083E
	...
	thumb_func_start ScrCmd_unk_482
ScrCmd_unk_482: ; 0x02042864
	push {r3-r5, lr}
	add r5, r0, #0x0
	bl ScriptReadHalfword
	add r1, r0, #0x0
	...
	thumb_func_start ScrCmd_unk_483
ScrCmd_unk_483: ; 0x02042894
	push {r3-r6, lr}
	sub sp, #0x4
	add r5, r0, #0x0
	bl ScriptReadHalfword
	...
	thumb_func_start ScrCmd_unk_484
ScrCmd_unk_484: ; 0x020428E0
	push {r3-r5, lr}
	add r5, r0, #0x0
	bl ScriptReadHalfword
	add r1, r0, #0x0
...
_0204294C: .word UNK_020F4334
	...
	thumb_func_start ScrCmd_unk_660
ScrCmd_unk_660: ; 0x02042950
	push {r3-r7, lr}
	add r5, r0, #0x0
	add r0, #0x80
	ldr r1, [r5, #0x8]
	...
	thumb_func_start ScrCmd_unk_661
ScrCmd_unk_661: ; 0x02042980
	push {r3, lr}
	add r0, #0x80
	ldr r0, [r0, #0x0]
	mov r1, #0x26
	...
	thumb_func_start ScrCmd_unk_662
ScrCmd_unk_662: ; 0x02042998
	push {r4, lr}
	add r4, r0, #0x0
	add r0, #0x80
	ldr r0, [r0, #0x0]
	...
	thumb_func_start ScrCmd_unk_663
ScrCmd_unk_663: ; 0x020429B8
	push {r3-r5, lr}
	add r5, r0, #0x0
	add r1, r5, #0x0
	add r1, #0x80
	...
	thumb_func_start ScrCmd_unk_664
ScrCmd_unk_664: ; 0x020429E8
	push {r3-r5, lr}
	add r5, r0, #0x0
	add r1, r5, #0x0
	add r1, #0x80
	...
	thumb_func_start ScrCmd_unk_665
ScrCmd_unk_665: ; 0x02042A18
	push {r3-r5, lr}
	add r5, r0, #0x0
	add r1, r5, #0x0
	add r1, #0x80
	...
	thumb_func_start ScrCmd_unk_666
ScrCmd_unk_666: ; 0x02042A48
	push {r4-r6, lr}
	add r4, r0, #0x0
	add r1, r4, #0x0
	add r1, #0x80
...
_02042A90:
	...
	thumb_func_start ScrCmd_unk_667
ScrCmd_unk_667: ; 0x02042A98
	push {r3-r7, lr}
	add r5, r0, #0x0
	bl ScriptReadHalfword
	add r1, r0, #0x0
