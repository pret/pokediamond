...
UNK_020F450E: ; 0x020F450E
	...
	thumb_func_start ScrCmd_KasekiCount
ScrCmd_KasekiCount: ; 0x02045268
	push {r3-r7, lr}
	add r4, r0, #0x0
	add r1, r4, #0x0
	add r1, #0x80
...
_020452B0: .word UNK_020F450C
	...
	thumb_func_start ScrCmd_ItemNoToMonsNo
ScrCmd_ItemNoToMonsNo: ; 0x020452B4
	push {r3-r5, lr}
	add r5, r0, #0x0
	bl ScriptReadHalfword
	add r1, r0, #0x0
...
_02045304: .word UNK_020F450E
	...
	thumb_func_start ScrCmd_KasekiItemNo
ScrCmd_KasekiItemNo: ; 0x02045308
	push {r4-r7, lr}
	sub sp, #0xc
	add r4, r0, #0x0
	add r1, r4, #0x0
...
_02045394: .word UNK_020F450C
	...
	thumb_func_start ScrCmd_ItemListSetProc
ScrCmd_ItemListSetProc: ; 0x02045398
	mov r0, #0x0
	bx lr

	thumb_func_start ScrCmd_ItemListGetResult
ScrCmd_ItemListGetResult: ; 0x0204539C
	mov r0, #0x0
	bx lr
