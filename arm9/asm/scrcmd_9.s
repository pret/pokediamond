...
UNK_020F4270: ; 0x020F4270
	...
	thumb_func_start ScrCmd_BroadcastTV
ScrCmd_BroadcastTV: ; 0x02041E40
	push {r3-r7, lr}
	add r4, r0, #0x0
...
_02041FD8: .word 0x00000233
	...
	thumb_func_start ScrCmd_TVEntryWatchHideItem
ScrCmd_TVEntryWatchHideItem: ; 0x02041FDC
	push {r4, lr}
	add r4, r0, #0x0
	bl ScriptReadHalfword
	add r1, r0, #0x0
	...
	thumb_func_start ScrCmd_TVEntryWatchChangeName
ScrCmd_TVEntryWatchChangeName: ; 0x02042000
	push {r3-r5, lr}
	add r5, r0, #0x0
	add r0, #0x80
	ldr r0, [r0, #0x0]
	...
	thumb_func_start ScrCmd_TVInterview
ScrCmd_TVInterview: ; 0x02042038
	push {r3-r7, lr}
	add r5, r0, #0x0
	add r0, #0x80
	ldr r0, [r0, #0x0]
...
_0204210C: .word 0x00000232
	...
	thumb_func_start ScrCmd_TVInterviewerCheck
ScrCmd_TVInterviewerCheck: ; 0x02042110
	push {r4-r6, lr}
	add r5, r0, #0x0
	bl ScriptReadHalfword
	add r1, r0, #0x0
	...
	thumb_func_start ScrCmd_TVEntryParkInfo
ScrCmd_TVEntryParkInfo: ; 0x0204214C
	push {r4-r6, lr}
	add r5, r0, #0x0
	add r0, #0x80
	ldr r0, [r0, #0x0]
