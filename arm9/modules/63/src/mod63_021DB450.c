...
void Title_SetupMonAnimationSprites(struct UnkStruct63_021DB450 * arg0) //TODO: this does a lot more than setup anim sprites
{
    ...
    for (u8 i = 0; i < 3; i++) //some kind of animation assignment TODO: investigate further
    {
        ...
        arg0->field_04[i] = sub_020073A0(arg0->field_00, &sp1C, MOD63_021DBEF0[i].field_00, MOD63_021DBEF0[i].field_04, 0x3FF, i, 0, 0);
    ...
    arg0->field_18 = sub_02012CDC(MOD63_021DB450, MOD63_021DB474, arg0->field_14, 0x4800, 1, 0x4C);
...
BOOL MOD63_021DB5CC(UnkStruct63_021DB450 *param0, u32 param1, s32 param2)
{
    ...
    switch(*state)
    {
        ...
        case 2:
            ...
            sub_020133AC(param0->field_18, MOD63_021DBF08[param1].field_00, MOD63_021DB940, param0->field_04[param1]);
            sub_020133AC(param0->field_18, MOD63_021DBF08[param1].field_04, MOD63_021DB940, param0->field_04[param1]);
            (*state)++;
            break;
        case 3:
            if (!sub_020133C8(param0->field_18) && param2 >= MOD63_021DBEC0[param1])
            {
