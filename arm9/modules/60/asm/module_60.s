...
MOD60_021D77B4: ; 0x021D77B4
	push {r4, lr}
	sub sp, #0x28
	ldr r4, _021D77D0 ; =MOD60_021D8140
	add r3, sp, #0
	mov r2, #5
_021D77BE:
	ldmia r4!, {r0, r1}
...
MOD60_021D7990: ; 0x021D7990
	...
	bl FUN_02016B94
	add r3, sp, #0
	ldr r4, _021D7A08 ; =MOD60_021D8114
	str r0, [r6, #0x14]
	add r2, r3, #0
	ldmia r4!, {r0, r1}
	stmia r3!, {r0, r1}
	...
	add r0, r2, #0
	bl FUN_02016BBC
	ldr r4, _021D7A0C ; =MOD60_021D8168
	add r3, sp, #0x10
	mov r2, #0xe
_021D79B8:
	ldmia r4!, {r0, r1}
	...
	sub r2, r2, #1
	bne _021D79B8
	ldr r5, _021D7A10 ; =MOD60_021D8104
	mov r7, #0
	add r4, sp, #0x10
_021D79C6:
	ldr r1, [r5]
...
_021D7E02:
	...
	ldr r2, [sp, #4]
	lsl r7, r0, #2
	ldr r0, _021D7E9C ; =MOD60_021D8124
	mov r1, #0x54
	mul r1, r2
	add r1, r6, r1
	str r1, [sp]
...
MOD60_021D7EA4: ; 0x021D7EA4
	...
	mov r0, #0x10
	str r0, [sp, #4]
	ldr r3, _021D8010 ; =MOD60_021D80FC
	ldr r2, [sp, #0x14]
	ldr r0, [sp, #0x10]
	ldrsb r2, [r3, r2]
	ldr r3, [sp, #0x18]
...
_021D7F54:
	...
	bls _021D8002
	bls _021D8002
	ldr r1, _021D8010 ; =MOD60_021D80FC
	ldr r0, [sp, #0x14]
	add r0, r1, r0
	str r0, [sp, #0x1c]
	ldr r0, [sp, #0x10]
...
MOD60_021D8168: ; 0x021D8168
	.byte 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x1F, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
	.byte 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x1E, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
	.byte 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x1D, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
	.byte 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x1F, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
