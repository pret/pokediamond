//============================================================================================
/**
 * @file	demo_ending_scene6.c
 * @brief	エンディングデモ（シーン６：スニーカーのカットイン）
 * @author	taya
 * @date	2006.06.08
 */
//============================================================================================
 ...
 */
//------------------------------------------------------------------
void* Ending_Scene6Init( ENDING_DEMO_WORK* mainWork, GF_BGL_INI* bgl )
{
 ...
 */
//------------------------------------------------------------------
BOOL Ending_Scene6InitWait( void* wk_ptr, int* seq )
{
 ...
 */
//------------------------------------------------------------------
BOOL Ending_Scene6Quit( void* wk_ptr, int* seq )
{
	SCENE_WORK* wk = wk_ptr;
 ...
 */
//------------------------------------------------------------------
BOOL Ending_Scene6Main( void* wk_ptr, int* seq )
{
	SCENE_WORK* wk = wk_ptr;
...
static BOOL setup_bg( SCENE_WORK* wk, int* seq )
{
	...
	case 1:
		ArcUtil_ScrnSet( ARC_ENDING, NARC_ending_endbg_cut_sneaker_nscr, wk->bgl, GF_BGL_FRAME2_M, 0, 0, FALSE, HEAPID_ENDING_DEMO );
		ArcUtil_ScrnSet( ARC_ENDING, NARC_ending_endbg_black_nscr, wk->bgl, GF_BGL_FRAME2_S, 0, 0, FALSE, HEAPID_ENDING_DEMO );
		(*seq)++;
		break;

	case 2:
		ArcUtil_BgCharSet( ARC_ENDING, NARC_ending_endbg_cut_sneaker_ncgr, wk->bgl, GF_BGL_FRAME2_M, 0, 0, FALSE, HEAPID_ENDING_DEMO );
		(*seq)++;
		break;
