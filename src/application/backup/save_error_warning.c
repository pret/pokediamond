//==============================================================================================
/**
 * @file	backup_recover.c
 * @brief	バックアップカートリッジ検査
 * @author	
 * @date	
 */
//==============================================================================================
...
#include "msgdata/msg_backup_recover.h"
...
//
//=================================================================================================
void SaveErrorWarningCall( int heapID, int error_msg_id )
{
	...
	if( error_msg_id == SAVEERROR_MSG_DISABLE_WRITE ){
		msgID = msg02;
	} else {
		msgID = msg01;
	}
	...
	//メッセージデータ読み込み
	msgman = MSGMAN_Create( MSGMAN_TYPE_DIRECT, ARC_MSG, NARC_msg_backup_recover_dat, heapID );
