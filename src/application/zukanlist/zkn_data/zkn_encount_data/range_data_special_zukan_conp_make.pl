...
#			
#------------------------------------------------------------------------------
@HIDEMAP_ZONEID = ( "ZONE_ID_D15", "ZONE_ID_D18", "ZONE_ID_D30", "ZONE_ID_L04" );	#隠しマップ
...
sub make_pokerangedata{
	...
	&make_mons_rang_out_file_dan( \@RANGE_DAN_SPECIAL, "zkn_dan_range_special_comp_mons", "モンスターダンジョン特殊分布ID　図鑑完成後\r\n" );

	#フィールド特殊分布ファイル
	&make_mons_rang_out_file_fld( \@RANGE_FLD_SPECIAL, "zkn_fld_range_special_comp_mons", "モンスターフィールド特殊分布ID　図鑑完成後\r\n" );
}
