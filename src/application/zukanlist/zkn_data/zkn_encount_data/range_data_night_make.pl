...
sub make_pokerangedata{
	#ダンジョン夜分布ファイル
	&make_mons_rang_out_file_dan( \@RANGE_DAN_NI, "zkn_dan_range_night_mons", "モンスターダンジョン夜分布ID\r\n" );

	#フィールド夜分布ファイル
	&make_mons_rang_out_file_fld( \@RANGE_FLD_NI, "zkn_fld_range_night_mons", "モンスターフィールド夜分布ID\r\n" );
}
