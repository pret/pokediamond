...
//	EX_DATA			OPERATOR_DEF_DATA_NUM, OPERATOR_PRI_NONE, OPERATOR_TARGET_NONE, OPERATOR_POS_NONE, OPERATOR_AXIS_NONE, OPERATOR_FLD_NONE, OPERATOR_CAMERA_AT
	
//	ADD_PARTICLE 	0,W_020_020_RING2, EMTFUNC_FIELD_OPERATOR
//	EX_DATA			OPERATOR_DEF_DATA_NUM, OPERATOR_PRI_NONE, OPERATOR_TARGET_NONE, OPERATOR_POS_NONE, OPERATOR_AXIS_NONE, OPERATOR_FLD_NONE, OPERATOR_CAMERA_AT

	ADD_PARTICLE 	0,W_020_020_RING1, EMTFUNC_ATTACK_POS
	ADD_PARTICLE 	0,W_020_020_RING2, EMTFUNC_ATTACK_POS
	
	LOOP_LABEL		2

		FUNC_CALL		WEST_SP_WE_SSP_POKE_SCALE_UPDOWN, 8, (WE_TOOL_M1 | WE_TOOL_SSP), 100, 70, 100, 100, 100, 1, (5 << 16) | 5
		WAIT_FLAG
		SE_L			SEQ_SE_DP_W020B
