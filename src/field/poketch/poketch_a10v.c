...
static void update_counter_actors( VIEWWORK* vwk, const VIEWPARAM* vpara );
 ...
 */
//------------------------------------------------------------------
BOOL Poketch_A10_SetViewWork( VIEWWORK** wk_ptr, const VIEWPARAM* vpara, GF_BGL_INI* bgl )
{
 ...
 */
//------------------------------------------------------------------
void Poketch_A10_DeleteViewWork( VIEWWORK* wk )
{
	if( wk != NULL )
	{
		cleanup_actors( wk );
...
static void setup_actors( VIEWWORK* wk, const VIEWPARAM* vpara )
{
	...
	ArcUtil_ObjCharSet(ARC_POKETCH_IMG, NARC_poketch_walk_obj_lz_ncgr, OBJTYPE_SUB, BUTTON_CHAROFS*0x20, 0, TRUE, POKETCH_APP_VIEW_HEAPID);

	PACT_TOOL_LoadCellDatas(&wk->clpack_button, ARC_POKETCH_IMG,
				NARC_poketch_walk_lz_ncer, NARC_poketch_walk_lz_nanr, POKETCH_APP_VIEW_HEAPID );
	...
	update_counter_actors( wk, vpara );
 ...
 */
//------------------------------------------------------------------
void Poketch_A10_SetViewCommand(VIEWWORK* wk, u32 cmd)
{
 ...
 */
//------------------------------------------------------------------
BOOL Poketch_A10_WaitViewCommand(VIEWWORK* wk, u32 cmd)
{
 ...
 */
//------------------------------------------------------------------
BOOL Poketch_A10_WaitViewCommandAll(VIEWWORK* wk)
{
...
static void CmdInit(TCB_PTR tcb, void *wk_ptr)
{
	...
	ArcUtil_BgCharSet( ARC_POKETCH_IMG, NARC_poketch_walk_lz_ncgr, vwk->bgl, USE_BG_FRAME, 0, 0, TRUE, HEAPID_POKETCH_APP );
	ArcUtil_ScrnSet( ARC_POKETCH_IMG, NARC_poketch_walk_lz_nscr, vwk->bgl, USE_BG_FRAME, 0, 0, TRUE, HEAPID_POKETCH_APP );
...
static void CmdButtonUpdate( TCB_PTR tcb, void* wk_adrs )
{
	...
	case BUTTON_STATE_TOUCH:
		PoketchSePlay(POKETCH_SE_PEDOMETER_BUTTON);
...
static void CmdCounterUpdate( TCB_PTR tcb, void* wk_adrs )
{
	...
	update_counter_actors( vwk, vpara );
