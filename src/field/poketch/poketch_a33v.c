 ...
 */
//------------------------------------------------------------------
BOOL Poketch_A33_SetViewWork( VIEWWORK** wk_ptr, const VIEWPARAM* vpara, GF_BGL_INI* bgl )
{
 ...
 */
//------------------------------------------------------------------
void Poketch_A33_DeleteViewWork( VIEWWORK* wk )
{
	if( wk != NULL )
	{
		sys_FreeMemoryEz( wk );
 ...
 */
//------------------------------------------------------------------
void Poketch_A33_SetViewCommand(VIEWWORK* wk, u32 cmd)
{
 ...
 */
//------------------------------------------------------------------
BOOL Poketch_A33_WaitViewCommand(VIEWWORK* wk, u32 cmd)
{
 ...
 */
//------------------------------------------------------------------
BOOL Poketch_A33_WaitViewCommandAll(VIEWWORK* wk)
{
...
static void CmdInit(TCB_PTR tcb, void *wk_ptr)
{
	...
	PoketchView_TestScreenMake( vwk->bgl, 33 , USE_BG_FRAME );
