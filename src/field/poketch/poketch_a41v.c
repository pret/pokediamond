 ...
 */
//------------------------------------------------------------------
BOOL Poketch_A41_SetViewWork( VIEWWORK** wk_ptr, const VIEWPARAM* vpara, GF_BGL_INI* bgl )
{
 ...
 */
//------------------------------------------------------------------
void Poketch_A41_DeleteViewWork( VIEWWORK* wk )
{
	if( wk != NULL )
	{
		sys_FreeMemoryEz( wk );
 ...
 */
//------------------------------------------------------------------
void Poketch_A41_SetViewCommand(VIEWWORK* wk, u32 cmd)
{
 ...
 */
//------------------------------------------------------------------
BOOL Poketch_A41_WaitViewCommand(VIEWWORK* wk, u32 cmd)
{
 ...
 */
//------------------------------------------------------------------
BOOL Poketch_A41_WaitViewCommandAll(VIEWWORK* wk)
{
...
static void CmdInit(TCB_PTR tcb, void *wk_ptr)
{
	...
	PoketchView_TestScreenMake( vwk->bgl, 41 , USE_BG_FRAME );
