...
// Global
//=================================================================================================
static BOOL WarningDispedFlag = FALSE;
...
//
//=================================================================================================
void AssertWarningResetCall( void )
{
	GF_BGL_INI*			bgl;
	...
	if( WarningDispedFlag == TRUE )
	{
		return;
	}
	WarningDispedFlag = TRUE;

	OS_InitArenaHiAndLo(OS_ARENA_MAIN);
	sys_InitHeapSystem(HeapInitHeader, NELEMS(HeapInitHeader), NELEMS(HeapInitHeader), 0);
